...
| Average Validation Loss | 803537631.9187 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 2516809728.0000 | Final epoch |
| Validation Loss | 2410612224.0000 | Final epoch |
| Loss Gap | -106197504.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 24027.6699 | Mean Absolute Error (lower is better) |
| MSE | 2449675008.0000 | Mean Squared Error (lower is better) |
| RMSE | 49494.1917 | Root Mean Squared Error (lower is better) |
| R2 | 0.2401 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 3043995392.0000 |
| Final Training Loss | 2516809728.0000 |
| Loss Improvement | 17.3% |
| Initial Validation Loss | 2683540480.0000 |
| Final Validation Loss | 2410612224.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 70.4592 | Final epoch |
| Validation Loss | 70.3734 | Final epoch |
| Loss Gap | -0.0857 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.7249 | Mean Absolute Error (lower is better) |
| MSE | 69.8099 | Mean Squared Error (lower is better) |
| RMSE | 8.3552 | Root Mean Squared Error (lower is better) |
| R2 | 0.3119 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 86.2726 |
| Final Training Loss | 70.4592 |
| Loss Improvement | 18.3% |
| Initial Validation Loss | 72.6695 |
| Final Validation Loss | 70.3734 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 601.4949 | Final epoch |
| Validation Loss | 601.3828 | Final epoch |
| Loss Gap | -0.1121 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 14.9877 | Mean Absolute Error (lower is better) |
| MSE | 600.3284 | Mean Squared Error (lower is better) |
| RMSE | 24.5016 | Root Mean Squared Error (lower is better) |
| R2 | -5.5365 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 601.0551 |
| Final Training Loss | 601.4949 |
| Loss Improvement | -0.1% |
| Initial Validation Loss | 600.8743 |
| Final Validation Loss | 601.3828 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 2516809728.0000 | 2410612224.0000 | -106197504.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 70.4592 | 70.3734 | -0.0857 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 601.4949 | 601.3828 | -0.1121 |
