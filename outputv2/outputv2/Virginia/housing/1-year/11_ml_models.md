...
| R² Score | 0.2658 | Poor fit |
| RMSE | 310,621.05 | Root Mean Square Error |
| MAE | 170,432.37 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Rooms | 76739.0362 | Positive |
| Number_of_Bedrooms | 58072.0607 | Positive |
| Year_Structure_Built | 37093.4307 | Positive |
| Building_Type | 20093.4738 | Positive |
| Housing_Unit_Weight | 18324.8711 | Positive |
| Number_of_Persons | 11446.9506 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3531 | Weak fit |
| RMSE | 600.20 | Root Mean Square Error |
| MAE | 438.23 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Building_Type | 167.3396 | Positive |
| Year_Structure_Built | 138.8292 | Positive |
| Number_of_Persons | 94.2129 | Positive |
| Number_of_Bedrooms | 91.8105 | Positive |
| Number_of_Rooms | 79.5429 | Positive |
| Housing_Unit_Weight | 36.9009 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5456 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 11,171 | 74.5% | Dominant cluster |
| Cluster 1 | 685 | 4.6% | Minor cluster |
| Cluster 2 | 2,093 | 14.0% | Moderate cluster |
| Cluster 3 | 557 | 3.7% | Minor cluster |
| Cluster 4 | 494 | 3.3% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 137.6%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9964 | — | — | — | 1 |
| polynomial_degree_2 | 0.9296 | — | — | — | 2 |
| polynomial_degree_1 | 0.8430 | — | — | — | 3 |
| holt_winters | 0.6676 | — | — | — | 4 |
| sma | 0.5830 | — | — | — | 5 |
| wma | 0.5469 | — | — | — | 6 |
| arima | 0.3952 | — | — | — | 7 |
| ewma | 0.2915 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9964. Models are ranked by R² score.*
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9860 | — | — | — | 1 |
| polynomial_degree_2 | 0.9675 | — | — | — | 2 |
| holt_winters | 0.9621 | — | — | — | 3 |
| wma | 0.9543 | — | — | — | 4 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9860. Models are ranked by R² score.*
