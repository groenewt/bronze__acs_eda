...
| Average Validation Loss | 481023332.2820 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1305420160.0000 | Final epoch |
| Validation Loss | 1443069312.0000 | Final epoch |
| Loss Gap | 137649152.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 18440.7441 | Mean Absolute Error (lower is better) |
| MSE | 1315998592.0000 | Mean Squared Error (lower is better) |
| RMSE | 36276.6949 | Root Mean Squared Error (lower is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 2418654208.0000 |
| Final Training Loss | 1305420160.0000 |
| Loss Improvement | 46.0% |
| Initial Validation Loss | 2573794560.0000 |
| Final Validation Loss | 1443069312.0000 |
| Validation Improvement | 43.9% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 78.9176 | Final epoch |
| Validation Loss | 75.1071 | Final epoch |
| Loss Gap | -3.8105 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.9531 | Mean Absolute Error (lower is better) |
| MSE | 77.7118 | Mean Squared Error (lower is better) |
| RMSE | 8.8154 | Root Mean Squared Error (lower is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 268.6692 |
| Final Training Loss | 78.9176 |
| Loss Improvement | 70.6% |
| Initial Validation Loss | 125.3070 |
| Final Validation Loss | 75.1071 |
| Validation Improvement | 40.1% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 603.7656 | Final epoch |
| Validation Loss | 609.7390 | Final epoch |
| Loss Gap | 5.9734 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 14.8727 | Mean Absolute Error (lower is better) |
| MSE | 602.5603 | Mean Squared Error (lower is better) |
| RMSE | 24.5471 | Root Mean Squared Error (lower is better) |
| R2 | -5.5290 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 604.6511 |
| Final Training Loss | 603.7656 |
| Loss Improvement | 0.1% |
| Initial Validation Loss | 610.0557 |
| Final Validation Loss | 609.7390 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1305420160.0000 | 1443069312.0000 | 137649152.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 78.9176 | 75.1071 | -3.8105 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 603.7656 | 609.7390 | 5.9734 |
