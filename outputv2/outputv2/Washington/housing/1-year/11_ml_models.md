...
| R² Score | 0.1797 | Poor fit |
| RMSE | 423,755.89 | Root Mean Square Error |
| MAE | 215,241.87 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 77512.9344 | Positive |
| Number_of_Rooms | 66539.7543 | Positive |
| Number_of_Bedrooms | 39299.7740 | Positive |
| Building_Type | 33578.4743 | Positive |
| Number_of_Persons | 18057.6411 | Positive |
| Housing_Unit_Weight | 10354.3090 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3224 | Weak fit |
| RMSE | 578.20 | Root Mean Square Error |
| MAE | 420.74 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 170.5558 | Positive |
| Number_of_Bedrooms | 111.0218 | Positive |
| Building_Type | 80.0198 | Positive |
| Number_of_Persons | 79.0691 | Positive |
| Housing_Unit_Weight | 61.9511 | Positive |
| Number_of_Rooms | 49.2229 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5326 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 198,515 | 71.8% | Dominant cluster |
| Cluster 1 | 13,428 | 4.9% | Minor cluster |
| Cluster 2 | 44,184 | 16.0% | Moderate cluster |
| Cluster 3 | 10,184 | 3.7% | Minor cluster |
| Cluster 4 | 10,005 | 3.6% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 131.7%).*
...
| polynomial_degree_2 | 0.9706 | — | — | — | 2 |
| polynomial_degree_1 | 0.9704 | — | — | — | 3 |
| holt_winters | 0.8879 | — | — | — | 4 |
| wma | 0.8053 | — | — | — | 5 |
| sma | 0.7913 | — | — | — | 6 |
| arima | 0.7493 | — | — | — | 7 |
| ewma | 0.5550 | — | — | — | 8 |
