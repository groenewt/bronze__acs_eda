...
| R² Score | 0.0253 | Poor fit |
| RMSE | 281,660.09 | Root Mean Square Error |
| MAE | 90,519.14 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Rooms | 19859.0188 | Positive |
| Building_Type | 13924.8045 | Positive |
| Number_of_Bedrooms | 12138.9756 | Positive |
| Year_Structure_Built | 11508.5973 | Positive |
| Number_of_Persons | 5553.0232 | Positive |
| Housing_Unit_Weight | 3170.2669 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.1820 | Poor fit |
| RMSE | 309.17 | Root Mean Square Error |
| MAE | 210.86 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Number_of_Bedrooms | 80.8521 | Positive |
| Building_Type | 48.4216 | Positive |
| Year_Structure_Built | 38.3268 | Positive |
| Number_of_Rooms | 22.7034 | Positive |
| Number_of_Persons | 13.9704 | Positive |
| Housing_Unit_Weight | 9.0315 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5202 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 101,193 | 74.1% | Dominant cluster |
| Cluster 1 | 8,572 | 6.3% | Minor cluster |
| Cluster 2 | 19,722 | 14.4% | Moderate cluster |
| Cluster 3 | 2,226 | 1.6% | Minor cluster |
| Cluster 4 | 4,809 | 3.5% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 137.1%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9745 | — | — | — | 1 |
| polynomial_degree_2 | 0.6320 | — | — | — | 2 |
| polynomial_degree_1 | 0.3022 | — | — | — | 3 |
| sma | 0.1599 | — | — | — | 4 |
| holt_winters | 0.1382 | — | — | — | 5 |
| wma | 0.0742 | — | — | — | 6 |
| ewma | -0.0893 | — | — | — | 7 |
| arima | -0.1834 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9745. Models are ranked by R² score.*
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9638 | — | — | — | 1 |
| wma | 0.9281 | — | — | — | 2 |
| polynomial_degree_2 | 0.9079 | — | — | — | 3 |
| sma | 0.8677 | — | — | — | 4 |
| holt_winters | 0.8581 | — | — | — | 5 |
| polynomial_degree_1 | 0.8128 | — | — | — | 6 |
| ewma | 0.7269 | — | — | — | 7 |
| arima | -2.9464 | — | — | — | 8 |



> *The polynomial_degree_3 model achieved the best fit with R² = 0.9638. Models are ranked by R² score.*
