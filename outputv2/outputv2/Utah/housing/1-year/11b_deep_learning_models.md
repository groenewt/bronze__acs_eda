...
| Average Validation Loss | 6613203922.2140 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 39235698688.0000 | Final epoch |
| Validation Loss | 33065672704.0000 | Final epoch |
| Loss Gap | -6170025984.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 53262.2773 | Mean Absolute Error (lower is better) |
| MSE | 35434291200.0000 | Mean Squared Error (lower is better) |
| RMSE | 188239.9830 | Root Mean Squared Error (lower is better) |
| R2 | -0.0574 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 92762382336.0000 |
| Final Training Loss | 39235698688.0000 |
| Loss Improvement | 57.7% |
| Initial Validation Loss | 82810888192.0000 |
| Final Validation Loss | 33065672704.0000 |
| Validation Improvement | 60.1% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 180.1002 | Final epoch |
| Validation Loss | 177.5954 | Final epoch |
| Loss Gap | -2.5048 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.3755 | Mean Absolute Error (lower is better) |
| MSE | 179.6039 | Mean Squared Error (lower is better) |
| RMSE | 13.4016 | Root Mean Squared Error (lower is better) |
| R2 | 0.0498 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 278.3336 |
| Final Training Loss | 180.1002 |
| Loss Improvement | 35.3% |
| Initial Validation Loss | 184.8247 |
| Final Validation Loss | 177.5954 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 313.9334 | Final epoch |
| Validation Loss | 17.8898 | Final epoch |
| Loss Gap | -296.0436 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 2.1700 | Mean Absolute Error (lower is better) |
| MSE | 17.9585 | Mean Squared Error (lower is better) |
| RMSE | 4.2378 | Root Mean Squared Error (lower is better) |
| R2 | 0.8419 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 24726.8203 |
| Final Training Loss | 313.9334 |
| Loss Improvement | 98.7% |
| Initial Validation Loss | 17228.5801 |
| Final Validation Loss | 17.8898 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 346198.8438 | Final epoch |
| Validation Loss | 346711.2812 | Final epoch |
| Loss Gap | 512.4375 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 194.1537 | Mean Absolute Error (lower is better) |
| MSE | 321194.9375 | Mean Squared Error (lower is better) |
| RMSE | 566.7406 | Root Mean Squared Error (lower is better) |
| R2 | 0.2853 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 535369.6250 |
| Final Training Loss | 346198.8438 |
| Loss Improvement | 35.3% |
| Initial Validation Loss | 496947.8750 |
| Final Validation Loss | 346711.2812 |
| Validation Improvement | 30.2% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.3038 | Final epoch |
| Validation Loss | 0.3035 | Final epoch |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.2935 | Mean Absolute Error (lower is better) |
| MSE | 0.3005 | Mean Squared Error (lower is better) |
| RMSE | 0.5481 | Root Mean Squared Error (lower is better) |
| R2 | 0.2609 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.8994 |
| Final Training Loss | 0.3038 |
| Loss Improvement | 66.2% |
| Initial Validation Loss | 0.4675 |
| Final Validation Loss | 0.3035 |
| Validation Improvement | 35.1% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 39235698688.0000 | 33065672704.0000 | -6170025984.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 180.1002 | 177.5954 | -2.5048 |
| Housing Quality | HousingQualityModel | 10,371 | 313.9334 | 17.8898 | -296.0436 |
| Cost Prediction | HousingDefaultModel | 10,306 | 346198.8438 | 346711.2812 | 512.4375 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.3038 | 0.3035 | -0.0003 |
