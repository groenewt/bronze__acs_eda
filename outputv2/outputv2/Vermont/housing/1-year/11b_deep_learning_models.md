...
| Average Validation Loss | 3057337848.4532 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 16371099648.0000 | Final epoch |
| Validation Loss | 15286170624.0000 | Final epoch |
| Loss Gap | -1084929024.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 35530.3047 | Mean Absolute Error (lower is better) |
| MSE | 17690083328.0000 | Mean Squared Error (lower is better) |
| RMSE | 133004.0726 | Root Mean Squared Error (lower is better) |
| R2 | -0.4480 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 44423991296.0000 |
| Final Training Loss | 16371099648.0000 |
| Loss Improvement | 63.1% |
| Initial Validation Loss | 43589648384.0000 |
| Final Validation Loss | 15286170624.0000 |
| Validation Improvement | 64.9% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 178.1278 | Final epoch |
| Validation Loss | 189.7391 | Final epoch |
| Loss Gap | 11.6113 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.1390 | Mean Absolute Error (lower is better) |
| MSE | 182.3462 | Mean Squared Error (lower is better) |
| RMSE | 13.5036 | Root Mean Squared Error (lower is better) |
| R2 | 0.0642 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 471.1276 |
| Final Training Loss | 178.1278 |
| Loss Improvement | 62.2% |
| Initial Validation Loss | 313.2826 |
| Final Validation Loss | 189.7391 |
| Validation Improvement | 39.4% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 603.3719 | Final epoch |
| Validation Loss | 20.3524 | Final epoch |
| Loss Gap | -583.0196 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 1.1189 | Mean Absolute Error (lower is better) |
| MSE | 20.9641 | Mean Squared Error (lower is better) |
| RMSE | 4.5787 | Root Mean Squared Error (lower is better) |
| R2 | 0.8868 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 57430.4570 |
| Final Training Loss | 603.3719 |
| Loss Improvement | 98.9% |
| Initial Validation Loss | 30171.3047 |
| Final Validation Loss | 20.3524 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 559487.1875 | Final epoch |
| Validation Loss | 518407.9062 | Final epoch |
| Loss Gap | -41079.2812 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 231.6528 | Mean Absolute Error (lower is better) |
| MSE | 548140.6875 | Mean Squared Error (lower is better) |
| RMSE | 740.3652 | Root Mean Squared Error (lower is better) |
| R2 | 0.3290 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1310005.5000 |
| Final Training Loss | 559487.1875 |
| Loss Improvement | 57.3% |
| Initial Validation Loss | 1233356.0000 |
| Final Validation Loss | 518407.9062 |
| Validation Improvement | 58.0% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.2692 | Final epoch |
| Validation Loss | 0.2684 | Final epoch |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.2645 | Mean Absolute Error (lower is better) |
| MSE | 0.2581 | Mean Squared Error (lower is better) |
| RMSE | 0.5080 | Root Mean Squared Error (lower is better) |
| R2 | 0.1861 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1.4240 |
| Final Training Loss | 0.2692 |
| Loss Improvement | 81.1% |
| Initial Validation Loss | 2.7512 |
| Final Validation Loss | 0.2684 |
| Validation Improvement | 90.2% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 16371099648.0000 | 15286170624.0000 | -1084929024.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 178.1278 | 189.7391 | 11.6113 |
| Housing Quality | HousingQualityModel | 10,371 | 603.3719 | 20.3524 | -583.0196 |
| Cost Prediction | HousingDefaultModel | 10,306 | 559487.1875 | 518407.9062 | -41079.2812 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.2692 | 0.2684 | -0.0008 |
