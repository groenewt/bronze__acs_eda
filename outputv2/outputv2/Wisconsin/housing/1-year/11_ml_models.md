...
| R² Score | 0.1677 | Poor fit |
| RMSE | 208,918.94 | Root Mean Square Error |
| MAE | 103,135.03 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 42766.7376 | Positive |
| Number_of_Rooms | 29975.3436 | Positive |
| Number_of_Bedrooms | 16045.0359 | Positive |
| Building_Type | 11342.7743 | Positive |
| Number_of_Persons | 10184.2062 | Positive |
| Housing_Unit_Weight | 3559.7513 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2738 | Poor fit |
| RMSE | 384.72 | Root Mean Square Error |
| MAE | 247.38 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 90.7635 | Positive |
| Number_of_Bedrooms | 72.6287 | Positive |
| Number_of_Persons | 59.9594 | Positive |
| Building_Type | 56.5487 | Positive |
| Housing_Unit_Weight | 53.3553 | Positive |
| Number_of_Rooms | 32.5041 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.4780 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 11,167 | 74.4% | Dominant cluster |
| Cluster 1 | 737 | 4.9% | Minor cluster |
| Cluster 2 | 2,075 | 13.8% | Moderate cluster |
| Cluster 3 | 605 | 4.0% | Minor cluster |
| Cluster 4 | 416 | 2.8% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 137.5%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9938 | — | — | — | 1 |
| polynomial_degree_2 | 0.9082 | — | — | — | 2 |
| polynomial_degree_1 | 0.8528 | — | — | — | 3 |
| holt_winters | 0.6833 | — | — | — | 4 |
| sma | 0.5854 | — | — | — | 5 |
| wma | 0.5568 | — | — | — | 6 |
| arima | 0.3591 | — | — | — | 7 |
| ewma | 0.3120 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9938. Models are ranked by R² score.*
...
| holt_winters | 0.9789 | — | — | — | 2 |
| polynomial_degree_2 | 0.9733 | — | — | — | 3 |
| wma | 0.9567 | — | — | — | 4 |
| sma | 0.9129 | — | — | — | 5 |
| polynomial_degree_1 | 0.8994 | — | — | — | 6 |
| ewma | 0.7756 | — | — | — | 7 |
| arima | -1.2606 | — | — | — | 8 |
