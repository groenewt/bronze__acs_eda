...
| Average Validation Loss | 4305471963.0879 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 21700349952.0000 | Final epoch |
| Validation Loss | 21526337536.0000 | Final epoch |
| Loss Gap | -174012416.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 36986.1094 | Mean Absolute Error (lower is better) |
| MSE | 21091420160.0000 | Mean Squared Error (lower is better) |
| RMSE | 145228.8544 | Root Mean Squared Error (lower is better) |
| R2 | 0.0833 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 26675509248.0000 |
| Final Training Loss | 21700349952.0000 |
| Loss Improvement | 18.7% |
| Initial Validation Loss | 22637809664.0000 |
| Final Validation Loss | 21526337536.0000 |
| Validation Improvement | 4.9% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 199.9634 | Final epoch |
| Validation Loss | 200.0007 | Final epoch |
| Loss Gap | 0.0374 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.8195 | Mean Absolute Error (lower is better) |
| MSE | 201.2205 | Mean Squared Error (lower is better) |
| RMSE | 14.1852 | Root Mean Squared Error (lower is better) |
| R2 | 0.0551 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 217.0762 |
| Final Training Loss | 199.9634 |
| Loss Improvement | 7.9% |
| Initial Validation Loss | 201.9214 |
| Final Validation Loss | 200.0007 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 12.1346 | Final epoch |
| Validation Loss | 12.3237 | Final epoch |
| Loss Gap | 0.1891 | LOW overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.8215 | Mean Absolute Error (lower is better) |
| MSE | 12.2670 | Mean Squared Error (lower is better) |
| RMSE | 3.5024 | Root Mean Squared Error (lower is better) |
| R2 | 0.9067 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 3472.4426 |
| Final Training Loss | 12.1346 |
| Loss Improvement | 99.7% |
| Initial Validation Loss | 4.7427 |
| Final Validation Loss | 12.3237 |
| Validation Improvement | -159.8% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 1046321.1875 | Final epoch |
| Validation Loss | 1022066.7500 | Final epoch |
| Loss Gap | -24254.4375 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 341.3530 | Mean Absolute Error (lower is better) |
| MSE | 1023849.0000 | Mean Squared Error (lower is better) |
| RMSE | 1011.8542 | Root Mean Squared Error (lower is better) |
| R2 | 0.3204 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1268392.6250 |
| Final Training Loss | 1046321.1875 |
| Loss Improvement | 17.5% |
| Initial Validation Loss | 1105231.3750 |
| Final Validation Loss | 1022066.7500 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.3631 | Final epoch |
| Validation Loss | 0.3653 | Final epoch |
| Loss Gap | 0.0022 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.2947 | Mean Absolute Error (lower is better) |
| MSE | 0.3615 | Mean Squared Error (lower is better) |
| RMSE | 0.6012 | Root Mean Squared Error (lower is better) |
| R2 | 0.3105 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.5232 |
| Final Training Loss | 0.3631 |
| Loss Improvement | 30.6% |
| Initial Validation Loss | 0.3873 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 21700349952.0000 | 21526337536.0000 | -174012416.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 199.9634 | 200.0007 | 0.0374 |
| Housing Quality | HousingQualityModel | 10,371 | 12.1346 | 12.3237 | 0.1891 |
| Cost Prediction | HousingDefaultModel | 10,306 | 1046321.1875 | 1022066.7500 | -24254.4375 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.3631 | 0.3653 | 0.0022 |
