...
| R² Score | 0.2221 | Poor fit |
| RMSE | 283,081.87 | Root Mean Square Error |
| MAE | 131,010.48 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Rooms | 49974.3823 | Positive |
| Year_Structure_Built | 49788.3202 | Positive |
| Number_of_Bedrooms | 32561.7533 | Positive |
| Building_Type | 17721.4434 | Positive |
| Number_of_Persons | 11021.8767 | Positive |
| Housing_Unit_Weight | 8340.2383 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3587 | Weak fit |
| RMSE | 451.40 | Root Mean Square Error |
| MAE | 311.31 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 154.8790 | Positive |
| Number_of_Bedrooms | 106.9461 | Positive |
| Building_Type | 74.0434 | Positive |
| Number_of_Rooms | 50.9186 | Positive |
| Number_of_Persons | 29.1875 | Positive |
| Housing_Unit_Weight | 22.9896 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5352 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 701,019 | 71.7% | Dominant cluster |
| Cluster 1 | 59,211 | 6.1% | Minor cluster |
| Cluster 2 | 153,928 | 15.7% | Moderate cluster |
| Cluster 3 | 26,267 | 2.7% | Minor cluster |
| Cluster 4 | 37,224 | 3.8% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 131.3%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9958 | — | — | — | 1 |
| polynomial_degree_2 | 0.9625 | — | — | — | 2 |
| polynomial_degree_1 | 0.9581 | — | — | — | 3 |
| holt_winters | 0.8515 | — | — | — | 4 |
| wma | 0.7551 | — | — | — | 5 |
| sma | 0.7509 | — | — | — | 6 |
| arima | 0.5989 | — | — | — | 7 |
| ewma | 0.4977 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9958. Models are ranked by R² score.*
...
| holt_winters | 0.9805 | — | — | — | 3 |
| wma | 0.9629 | — | — | — | 4 |
| sma | 0.9230 | — | — | — | 5 |
| polynomial_degree_1 | 0.9148 | — | — | — | 6 |
| ewma | 0.7888 | — | — | — | 7 |
| arima | -0.0490 | — | — | — | 8 |
