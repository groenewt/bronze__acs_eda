...
| :--- | :--- | :--- |
| Best Model | linear | — |
| R² Score | 0.0391 | Poor fit |
| RMSE | 387,298.13 | Root Mean Square Error |
| MAE | 152,467.91 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Rooms | 51462.5854 | 1 |
| Building_Type | 40741.2534 | 2 |
| Number_of_Bedrooms | 39885.4599 | 3 |
| Number_of_Persons | 12276.6668 | 4 |
| Housing_Unit_Weight | 11575.0000 | 5 |
| Year_Structure_Built | 339.4391 | 6 |
| Census_Region | 0.0000 | 7 |
| Housing_Adjustment_Factor | 0.0000 | 8 |
| Housing_Unit_Type | 0.0000 | 9 |
| Census_Division | 0.0000 | 10 |
...
| R² Score | 0.2591 | Poor fit |
| RMSE | 384.62 | Root Mean Square Error |
| MAE | 264.52 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| :--- | :--- | :--- |
| Number_of_Bedrooms | 124.1208 | Positive |
| Housing_Unit_Weight | 75.4120 | Positive |
| Year_Structure_Built | 72.6501 | Positive |
| Building_Type | 69.9812 | Positive |
| Number_of_Persons | 52.3359 | Positive |
| Number_of_Rooms | 29.3169 | Positive |
...
| Silhouette Score | 0.5174 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 19,398 | 79.0% | Dominant cluster |
| Cluster 1 | 1,127 | 4.6% | Minor cluster |
| Cluster 2 | 2,350 | 9.6% | Minor cluster |
| Cluster 3 | 954 | 3.9% | Minor cluster |
| Cluster 4 | 721 | 2.9% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 148.0%).*
...
| polynomial_degree_2 | 0.9322 | — | — | — | 2 |
| polynomial_degree_1 | 0.8966 | — | — | — | 3 |
| holt_winters | 0.7511 | — | — | — | 4 |
| sma | 0.6585 | — | — | — | 5 |
| wma | 0.6489 | — | — | — | 6 |
| arima | 0.4553 | — | — | — | 7 |
| ewma | 0.3860 | — | — | — | 8 |
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9619 | — | — | — | 1 |
| wma | 0.9478 | — | — | — | 2 |
| holt_winters | 0.9290 | — | — | — | 3 |
| polynomial_degree_2 | 0.9252 | — | — | — | 4 |
| polynomial_degree_1 | 0.9224 | — | — | — | 5 |
| sma | 0.9005 | — | — | — | 6 |
| ewma | 0.7706 | — | — | — | 7 |
| arima | -1.6799 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9619. Models are ranked by R² score.*
