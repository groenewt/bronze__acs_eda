...
| Average Validation Loss | 452156987.7524 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1446808960.0000 | Final epoch |
| Validation Loss | 1356470272.0000 | Final epoch |
| Loss Gap | -90338688.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 17243.0430 | Mean Absolute Error (lower is better) |
| MSE | 1364527616.0000 | Mean Squared Error (lower is better) |
| RMSE | 36939.5129 | Root Mean Squared Error (lower is better) |
| R2 | 0.2193 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1965898752.0000 |
| Final Training Loss | 1446808960.0000 |
| Loss Improvement | 26.4% |
| Initial Validation Loss | 1599272448.0000 |
| Final Validation Loss | 1356470272.0000 |
| Validation Improvement | 15.2% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 73.0523 | Final epoch |
| Validation Loss | 73.9463 | Final epoch |
| Loss Gap | 0.8940 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.7219 | Mean Absolute Error (lower is better) |
| MSE | 72.8604 | Mean Squared Error (lower is better) |
| RMSE | 8.5358 | Root Mean Squared Error (lower is better) |
| R2 | 0.3154 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 116.1190 |
| Final Training Loss | 73.0523 |
| Loss Improvement | 37.1% |
| Initial Validation Loss | 77.7522 |
| Final Validation Loss | 73.9463 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 618.6595 | Final epoch |
| Validation Loss | 617.3110 | Final epoch |
| Loss Gap | -1.3484 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 14.9349 | Mean Absolute Error (lower is better) |
| MSE | 617.1887 | Mean Squared Error (lower is better) |
| RMSE | 24.8433 | Root Mean Squared Error (lower is better) |
| R2 | -5.4000 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 618.8735 |
| Final Training Loss | 618.6595 |
| Loss Improvement | 0.0% |
| Initial Validation Loss | 617.0469 |
| Final Validation Loss | 617.3110 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1446808960.0000 | 1356470272.0000 | -90338688.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 73.0523 | 73.9463 | 0.8940 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 618.6595 | 617.3110 | -1.3484 |
