...
| Average Validation Loss | 24070475615.5510 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 116111237120.0000 | Final epoch |
| Validation Loss | 120351154176.0000 | Final epoch |
| Loss Gap | 4239917056.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 91540.0938 | Mean Absolute Error (lower is better) |
| MSE | 114026807296.0000 | Mean Squared Error (lower is better) |
| RMSE | 337678.5562 | Root Mean Squared Error (lower is better) |
| R2 | -0.0832 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 307446317056.0000 |
| Final Training Loss | 116111237120.0000 |
| Loss Improvement | 62.2% |
| Initial Validation Loss | 315752513536.0000 |
| Final Validation Loss | 120351154176.0000 |
| Validation Improvement | 61.9% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 242.0703 | Final epoch |
| Validation Loss | 235.9069 | Final epoch |
| Loss Gap | -6.1634 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 8.0290 | Mean Absolute Error (lower is better) |
| MSE | 238.5152 | Mean Squared Error (lower is better) |
| RMSE | 15.4439 | Root Mean Squared Error (lower is better) |
| R2 | 0.0376 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 476.9714 |
| Final Training Loss | 242.0703 |
| Loss Improvement | 49.2% |
| Initial Validation Loss | 292.5804 |
| Final Validation Loss | 235.9069 |
| Validation Improvement | 19.4% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 333.4931 | Final epoch |
| Validation Loss | 11.5130 | Final epoch |
| Loss Gap | -321.9801 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 1.6472 | Mean Absolute Error (lower is better) |
| MSE | 11.3031 | Mean Squared Error (lower is better) |
| RMSE | 3.3620 | Root Mean Squared Error (lower is better) |
| R2 | 0.8303 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 36892.5664 |
| Final Training Loss | 333.4931 |
| Loss Improvement | 99.1% |
| Initial Validation Loss | 27751.7168 |
| Final Validation Loss | 11.5130 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 887952.6875 | Final epoch |
| Validation Loss | 1223653.8750 | Final epoch |
| Loss Gap | 335701.1875 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 325.5223 | Mean Absolute Error (lower is better) |
| MSE | 1161809.8750 | Mean Squared Error (lower is better) |
| RMSE | 1077.8728 | Root Mean Squared Error (lower is better) |
| R2 | 0.1223 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1473505.1250 |
| Final Training Loss | 887952.6875 |
| Loss Improvement | 39.7% |
| Initial Validation Loss | 1735661.0000 |
| Final Validation Loss | 1223653.8750 |
| Validation Improvement | 29.5% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.4673 | Final epoch |
| Validation Loss | 0.4603 | Final epoch |
| Loss Gap | -0.0070 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3866 | Mean Absolute Error (lower is better) |
| MSE | 0.4651 | Mean Squared Error (lower is better) |
| RMSE | 0.6820 | Root Mean Squared Error (lower is better) |
| R2 | 0.1577 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1.9625 |
| Final Training Loss | 0.4673 |
| Loss Improvement | 76.2% |
| Initial Validation Loss | 1.5031 |
| Final Validation Loss | 0.4603 |
| Validation Improvement | 69.4% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 116111237120.0000 | 120351154176.0000 | 4239917056.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 242.0703 | 235.9069 | -6.1634 |
| Housing Quality | HousingQualityModel | 10,371 | 333.4931 | 11.5130 | -321.9801 |
| Cost Prediction | HousingDefaultModel | 10,306 | 887952.6875 | 1223653.8750 | 335701.1875 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.4673 | 0.4603 | -0.0070 |
