...
| Average Validation Loss | 95849.1798 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 94023.8281 | Final epoch |
| Validation Loss | 88697.7891 | Final epoch |
| Loss Gap | -5326.0391 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 102.3364 | Mean Absolute Error (lower is better) |
| MSE | 89831.4375 | Mean Squared Error (lower is better) |
| RMSE | 299.7189 | Root Mean Squared Error (lower is better) |
| R2 | 0.0564 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 256364.7344 |
| Final Training Loss | 94023.8281 |
| Loss Improvement | 63.3% |
| Initial Validation Loss | 92514.9297 |
| Final Validation Loss | 88697.7891 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 234.1676 | Final epoch |
| Validation Loss | 238.9722 | Final epoch |
| Loss Gap | 4.8045 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 7.8896 | Mean Absolute Error (lower is better) |
| MSE | 233.0125 | Mean Squared Error (lower is better) |
| RMSE | 15.2647 | Root Mean Squared Error (lower is better) |
| R2 | 0.0488 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 292.0153 |
| Final Training Loss | 234.1676 |
| Loss Improvement | 19.8% |
| Initial Validation Loss | 245.5015 |
| Final Validation Loss | 238.9722 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.0085 | Final epoch |
| Validation Loss | 0.0159 | Final epoch |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.0378 | Mean Absolute Error (lower is better) |
| MSE | 0.0154 | Mean Squared Error (lower is better) |
| RMSE | 0.1240 | Root Mean Squared Error (lower is better) |
| R2 | 0.9899 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.5887 |
| Final Training Loss | 0.0085 |
| Loss Improvement | 98.6% |
| Initial Validation Loss | 0.0400 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 390687.0000 | Final epoch |
| Validation Loss | 390308.6562 | Final epoch |
| Loss Gap | -378.3438 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 242.0604 | Mean Absolute Error (lower is better) |
| MSE | 390595.6250 | Mean Squared Error (lower is better) |
| RMSE | 624.9765 | Root Mean Squared Error (lower is better) |
| R2 | 0.0655 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 512132.8438 |
| Final Training Loss | 390687.0000 |
| Loss Improvement | 23.7% |
| Initial Validation Loss | 398016.2188 |
| Final Validation Loss | 390308.6562 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.4717 | Final epoch |
| Validation Loss | 0.4658 | Final epoch |
| Loss Gap | -0.0059 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3788 | Mean Absolute Error (lower is better) |
| MSE | 0.4656 | Mean Squared Error (lower is better) |
| RMSE | 0.6823 | Root Mean Squared Error (lower is better) |
| R2 | 0.1690 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.8381 |
| Final Training Loss | 0.4717 |
| Loss Improvement | 43.7% |
| Initial Validation Loss | 0.5102 |
| Final Validation Loss | 0.4658 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 94023.8281 | 88697.7891 | -5326.0391 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 234.1676 | 238.9722 | 4.8045 |
| Housing Quality | HousingQualityModel | 10,371 | 0.0085 | 0.0159 | 0.0075 |
| Cost Prediction | HousingDefaultModel | 10,306 | 390687.0000 | 390308.6562 | -378.3438 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.4717 | 0.4658 | -0.0059 |
