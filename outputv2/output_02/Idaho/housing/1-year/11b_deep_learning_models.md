...
| Average Validation Loss | 5418326599.3886 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 27367284736.0000 | Final epoch |
| Validation Loss | 27091351552.0000 | Final epoch |
| Loss Gap | -275933184.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 46124.9922 | Mean Absolute Error (lower is better) |
| MSE | 25361033216.0000 | Mean Squared Error (lower is better) |
| RMSE | 159251.4779 | Root Mean Squared Error (lower is better) |
| R2 | -0.3831 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 57784434688.0000 |
| Final Training Loss | 27367284736.0000 |
| Loss Improvement | 52.6% |
| Initial Validation Loss | 57521938432.0000 |
| Final Validation Loss | 27091351552.0000 |
| Validation Improvement | 52.9% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 184.8108 | Final epoch |
| Validation Loss | 186.1445 | Final epoch |
| Loss Gap | 1.3337 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.4906 | Mean Absolute Error (lower is better) |
| MSE | 183.4888 | Mean Squared Error (lower is better) |
| RMSE | 13.5458 | Root Mean Squared Error (lower is better) |
| R2 | 0.0500 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 312.6094 |
| Final Training Loss | 184.8108 |
| Loss Improvement | 40.9% |
| Initial Validation Loss | 200.4732 |
| Final Validation Loss | 186.1445 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 362.1917 | Final epoch |
| Validation Loss | 9.7147 | Final epoch |
| Loss Gap | -352.4771 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.9793 | Mean Absolute Error (lower is better) |
| MSE | 10.3130 | Mean Squared Error (lower is better) |
| RMSE | 3.2114 | Root Mean Squared Error (lower is better) |
| R2 | 0.8702 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 35778.1172 |
| Final Training Loss | 362.1917 |
| Loss Improvement | 99.0% |
| Initial Validation Loss | 42777.6836 |
| Final Validation Loss | 9.7147 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 291676.6562 | Final epoch |
| Validation Loss | 281248.7500 | Final epoch |
| Loss Gap | -10427.9062 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 187.7275 | Mean Absolute Error (lower is better) |
| MSE | 294527.4688 | Mean Squared Error (lower is better) |
| RMSE | 542.7038 | Root Mean Squared Error (lower is better) |
| R2 | 0.2519 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 501355.8438 |
| Final Training Loss | 291676.6562 |
| Loss Improvement | 41.8% |
| Initial Validation Loss | 408338.3438 |
| Final Validation Loss | 281248.7500 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.3403 | Final epoch |
| Validation Loss | 0.3340 | Final epoch |
| Loss Gap | -0.0063 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3122 | Mean Absolute Error (lower is better) |
| MSE | 0.3352 | Mean Squared Error (lower is better) |
| RMSE | 0.5790 | Root Mean Squared Error (lower is better) |
| R2 | 0.1968 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1.8305 |
| Final Training Loss | 0.3403 |
| Loss Improvement | 81.4% |
| Initial Validation Loss | 0.7390 |
| Final Validation Loss | 0.3340 |
| Validation Improvement | 54.8% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 27367284736.0000 | 27091351552.0000 | -275933184.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 184.8108 | 186.1445 | 1.3337 |
| Housing Quality | HousingQualityModel | 10,371 | 362.1917 | 9.7147 | -352.4771 |
| Cost Prediction | HousingDefaultModel | 10,306 | 291676.6562 | 281248.7500 | -10427.9062 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.3403 | 0.3340 | -0.0063 |
