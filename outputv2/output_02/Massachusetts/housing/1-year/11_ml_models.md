...
| R² Score | 0.1747 | Poor fit |
| RMSE | 440,911.37 | Root Mean Square Error |
| MAE | 221,766.81 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Rooms | 75737.5317 | Positive |
| Year_Structure_Built | 62481.2043 | Positive |
| Number_of_Bedrooms | 52599.6710 | Positive |
| Building_Type | 26422.4396 | Positive |
| Housing_Unit_Weight | 16572.6789 | Positive |
| Number_of_Persons | 12496.0994 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2656 | Poor fit |
| RMSE | 728.38 | Root Mean Square Error |
| MAE | 551.58 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 185.1933 | Positive |
| Number_of_Persons | 161.6311 | Positive |
| Number_of_Bedrooms | 103.3686 | Positive |
| Building_Type | 57.4768 | Positive |
| Housing_Unit_Weight | 41.2752 | Positive |
| Number_of_Rooms | 34.1503 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.3357 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 23,476 | 9.0% | Minor cluster |
| Cluster 1 | 13,535 | 5.2% | Minor cluster |
| Cluster 2 | 122,179 | 47.1% | Dominant cluster |
| Cluster 3 | 83,290 | 32.1% | Major cluster |
| Cluster 4 | 16,925 | 6.5% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 83.7%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9967 | — | — | — | 1 |
| polynomial_degree_2 | 0.9482 | — | — | — | 2 |
| polynomial_degree_1 | 0.9068 | — | — | — | 3 |
| holt_winters | 0.7575 | — | — | — | 4 |
| sma | 0.6612 | — | — | — | 5 |
| wma | 0.6421 | — | — | — | 6 |
| arima | 0.5155 | — | — | — | 7 |
| ewma | 0.3813 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9967. Models are ranked by R² score.*
...
| holt_winters | 0.9894 | — | — | — | 3 |
| wma | 0.9676 | — | — | — | 4 |
| sma | 0.9324 | — | — | — | 5 |
| polynomial_degree_1 | 0.9184 | — | — | — | 6 |
| ewma | 0.7955 | — | — | — | 7 |
| arima | 0.1699 | — | — | — | 8 |
