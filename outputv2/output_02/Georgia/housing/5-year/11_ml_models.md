...
| R² Score | 0.4696 | Weak fit |
| RMSE | 3.47 | Root Mean Square Error |
| MAE | 2.52 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Building_Type | 1.1523 | Positive |
| Number_of_Rooms | 1.1185 | Positive |
| Year_Structure_Built | 0.8153 | Positive |
| Number_of_Bedrooms | 0.5309 | Positive |
| Housing_Unit_Weight | 0.2356 | Positive |
| Number_of_Persons | 0.2063 | Positive |
| Housing_Adjustment_Factor | 0.1493 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3260 | Weak fit |
| RMSE | 318.42 | Root Mean Square Error |
| MAE | 224.99 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 72.8489 | Positive |
| Building_Type | 66.4762 | Positive |
| Number_of_Rooms | 61.4580 | Positive |
| Number_of_Bedrooms | 52.2370 | Positive |
| Number_of_Persons | 26.9338 | Positive |
| Housing_Unit_Weight | 21.6638 | Positive |
| Housing_Adjustment_Factor | 13.8100 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 49,553 | 8.3% | Minor cluster |
| Cluster 1 | 167,600 | 28.0% | Major cluster |
| Cluster 2 | 271,830 | 45.3% | Dominant cluster |
| Cluster 3 | 64,196 | 10.7% | Moderate cluster |
| Cluster 4 | 46,394 | 7.7% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 73.5%).*
...
| polynomial_degree_1 | 0.5410 | — | — | — | 3 |
| holt_winters | 0.5410 | — | — | — | 4 |
| ewma | 0.3239 | — | — | — | 5 |
| sma | 0.0000 | — | — | — | 6 |
| wma | -0.0902 | — | — | — | 7 |
| arima | -14110.9831 | — | — | — | 8 |
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9965 | — | — | — | 1 |
| holt_winters | 0.9924 | — | — | — | 2 |
| polynomial_degree_2 | 0.9844 | — | — | — | 3 |
| wma | 0.9613 | — | — | — | 4 |
| sma | 0.9225 | — | — | — | 5 |
| polynomial_degree_1 | 0.9173 | — | — | — | 6 |
| ewma | 0.7772 | — | — | — | 7 |
| arima | -1.7322 | — | — | — | 8 |



> *The polynomial_degree_3 model achieved the best fit with R² = 0.9965. Models are ranked by R² score.*
