...
| R² Score | 0.2030 | Poor fit |
| RMSE | 223,499.89 | Root Mean Square Error |
| MAE | 100,419.97 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 40846.5263 | Positive |
| Number_of_Rooms | 32823.3145 | Positive |
| Building_Type | 26532.1586 | Positive |
| Number_of_Bedrooms | 23396.6783 | Positive |
| Housing_Unit_Weight | 6710.0865 | Positive |
| Number_of_Persons | 6447.7329 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2296 | Poor fit |
| RMSE | 404.49 | Root Mean Square Error |
| MAE | 289.63 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 74.8165 | Positive |
| Number_of_Bedrooms | 67.9833 | Positive |
| Number_of_Rooms | 51.2321 | Positive |
| Number_of_Persons | 47.9453 | Positive |
| Building_Type | 46.8274 | Positive |
| Housing_Unit_Weight | 11.9952 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5140 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 21,465 | 11.7% | Moderate cluster |
| Cluster 1 | 7,993 | 4.3% | Minor cluster |
| Cluster 2 | 141,314 | 76.8% | Dominant cluster |
| Cluster 3 | 4,229 | 2.3% | Minor cluster |
| Cluster 4 | 9,028 | 4.9% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 142.8%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9930 | — | — | — | 1 |
| polynomial_degree_2 | 0.9575 | — | — | — | 2 |
| polynomial_degree_1 | 0.8634 | — | — | — | 3 |
| holt_winters | 0.7009 | — | — | — | 4 |
| sma | 0.6179 | — | — | — | 5 |
| wma | 0.5853 | — | — | — | 6 |
| arima | 0.4231 | — | — | — | 7 |
| ewma | 0.3252 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9930. Models are ranked by R² score.*
...
| holt_winters | 0.9665 | — | — | — | 3 |
| polynomial_degree_1 | 0.9537 | — | — | — | 4 |
| wma | 0.9517 | — | — | — | 5 |
| sma | 0.9188 | — | — | — | 6 |
| ewma | 0.7789 | — | — | — | 7 |
| arima | -1.8378 | — | — | — | 8 |
