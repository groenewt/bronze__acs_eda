...
| Average Validation Loss | 1547931865.4923 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 7892846080.0000 | Final epoch |
| Validation Loss | 7739366400.0000 | Final epoch |
| Loss Gap | -153479680.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 22987.8926 | Mean Absolute Error (lower is better) |
| MSE | 8655361024.0000 | Mean Squared Error (lower is better) |
| RMSE | 93034.1928 | Root Mean Squared Error (lower is better) |
| R2 | -0.3819 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 15241521152.0000 |
| Final Training Loss | 7892846080.0000 |
| Loss Improvement | 48.2% |
| Initial Validation Loss | 12489669632.0000 |
| Final Validation Loss | 7739366400.0000 |
| Validation Improvement | 38.0% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 200.9737 | Final epoch |
| Validation Loss | 196.2351 | Final epoch |
| Loss Gap | -4.7386 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.6525 | Mean Absolute Error (lower is better) |
| MSE | 196.9322 | Mean Squared Error (lower is better) |
| RMSE | 14.0333 | Root Mean Squared Error (lower is better) |
| R2 | 0.0447 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 277.6601 |
| Final Training Loss | 200.9737 |
| Loss Improvement | 27.6% |
| Initial Validation Loss | 204.6715 |
| Final Validation Loss | 196.2351 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 233.5874 | Final epoch |
| Validation Loss | 56.5641 | Final epoch |
| Loss Gap | -177.0233 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 4.3200 | Mean Absolute Error (lower is better) |
| MSE | 56.4986 | Mean Squared Error (lower is better) |
| RMSE | 7.5166 | Root Mean Squared Error (lower is better) |
| R2 | 0.4337 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 17071.8867 |
| Final Training Loss | 233.5874 |
| Loss Improvement | 98.6% |
| Initial Validation Loss | 1322.0195 |
| Final Validation Loss | 56.5641 |
| Validation Improvement | 95.7% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 295453.0312 | Final epoch |
| Validation Loss | 292674.2188 | Final epoch |
| Loss Gap | -2778.8125 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 224.9983 | Mean Absolute Error (lower is better) |
| MSE | 312499.9375 | Mean Squared Error (lower is better) |
| RMSE | 559.0169 | Root Mean Squared Error (lower is better) |
| R2 | 0.2247 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 498765.6250 |
| Final Training Loss | 295453.0312 |
| Loss Improvement | 40.8% |
| Initial Validation Loss | 327147.3750 |
| Final Validation Loss | 292674.2188 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.4489 | Final epoch |
| Validation Loss | 0.4436 | Final epoch |
| Loss Gap | -0.0052 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3248 | Mean Absolute Error (lower is better) |
| MSE | 0.4378 | Mean Squared Error (lower is better) |
| RMSE | 0.6617 | Root Mean Squared Error (lower is better) |
| R2 | 0.3502 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1.7216 |
| Final Training Loss | 0.4489 |
| Loss Improvement | 73.9% |
| Initial Validation Loss | 0.7165 |
| Final Validation Loss | 0.4436 |
| Validation Improvement | 38.1% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 7892846080.0000 | 7739366400.0000 | -153479680.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 200.9737 | 196.2351 | -4.7386 |
| Housing Quality | HousingQualityModel | 10,371 | 233.5874 | 56.5641 | -177.0233 |
| Cost Prediction | HousingDefaultModel | 10,306 | 295453.0312 | 292674.2188 | -2778.8125 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.4489 | 0.4436 | -0.0052 |
