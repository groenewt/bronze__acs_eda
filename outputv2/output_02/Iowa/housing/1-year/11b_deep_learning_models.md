...
| Average Validation Loss | 1480600963.0944 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 7758251008.0000 | Final epoch |
| Validation Loss | 7402722304.0000 | Final epoch |
| Loss Gap | -355528704.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 24918.2539 | Mean Absolute Error (lower is better) |
| MSE | 7795688960.0000 | Mean Squared Error (lower is better) |
| RMSE | 88293.1988 | Root Mean Squared Error (lower is better) |
| R2 | -0.1416 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 17075725312.0000 |
| Final Training Loss | 7758251008.0000 |
| Loss Improvement | 54.6% |
| Initial Validation Loss | 13408495616.0000 |
| Final Validation Loss | 7402722304.0000 |
| Validation Improvement | 44.8% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 158.1458 | Final epoch |
| Validation Loss | 159.7556 | Final epoch |
| Loss Gap | 1.6097 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 5.7771 | Mean Absolute Error (lower is better) |
| MSE | 156.1295 | Mean Squared Error (lower is better) |
| RMSE | 12.4952 | Root Mean Squared Error (lower is better) |
| R2 | 0.0648 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 215.0001 |
| Final Training Loss | 158.1458 |
| Loss Improvement | 26.4% |
| Initial Validation Loss | 165.2681 |
| Final Validation Loss | 159.7556 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 242.2809 | Final epoch |
| Validation Loss | 28.2024 | Final epoch |
| Loss Gap | -214.0785 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 1.0585 | Mean Absolute Error (lower is better) |
| MSE | 28.4658 | Mean Squared Error (lower is better) |
| RMSE | 5.3353 | Root Mean Squared Error (lower is better) |
| R2 | 0.8404 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 15843.5615 |
| Final Training Loss | 242.2809 |
| Loss Improvement | 98.5% |
| Initial Validation Loss | 554.2667 |
| Final Validation Loss | 28.2024 |
| Validation Improvement | 94.9% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 312364.1875 | Final epoch |
| Validation Loss | 282323.2188 | Final epoch |
| Loss Gap | -30040.9688 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 202.5262 | Mean Absolute Error (lower is better) |
| MSE | 310037.4375 | Mean Squared Error (lower is better) |
| RMSE | 556.8101 | Root Mean Squared Error (lower is better) |
| R2 | 0.3085 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 478215.7188 |
| Final Training Loss | 312364.1875 |
| Loss Improvement | 34.7% |
| Initial Validation Loss | 354847.9688 |
| Final Validation Loss | 282323.2188 |
| Validation Improvement | 20.4% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.2973 | Final epoch |
| Validation Loss | 0.2952 | Final epoch |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.2769 | Mean Absolute Error (lower is better) |
| MSE | 0.2941 | Mean Squared Error (lower is better) |
| RMSE | 0.5424 | Root Mean Squared Error (lower is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.9006 |
| Final Training Loss | 0.2973 |
| Loss Improvement | 67.0% |
| Initial Validation Loss | 0.3454 |
| Final Validation Loss | 0.2952 |
| Validation Improvement | 14.5% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 7758251008.0000 | 7402722304.0000 | -355528704.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 158.1458 | 159.7556 | 1.6097 |
| Housing Quality | HousingQualityModel | 10,371 | 242.2809 | 28.2024 | -214.0785 |
| Cost Prediction | HousingDefaultModel | 10,306 | 312364.1875 | 282323.2188 | -30040.9688 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.2973 | 0.2952 | -0.0021 |
