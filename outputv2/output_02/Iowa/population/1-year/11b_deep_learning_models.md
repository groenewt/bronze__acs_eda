...
| Average Validation Loss | 381685699.1934 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1145069184.0000 | Final epoch |
| Validation Loss | 1145056384.0000 | Final epoch |
| Loss Gap | -12800.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 15631.6260 | Mean Absolute Error (lower is better) |
| MSE | 1120952832.0000 | Mean Squared Error (lower is better) |
| RMSE | 33480.6337 | Root Mean Squared Error (lower is better) |
| R2 | 0.2366 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1594059648.0000 |
| Final Training Loss | 1145069184.0000 |
| Loss Improvement | 28.2% |
| Initial Validation Loss | 1358673792.0000 |
| Final Validation Loss | 1145056384.0000 |
| Validation Improvement | 15.7% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 73.2760 | Final epoch |
| Validation Loss | 73.2507 | Final epoch |
| Loss Gap | -0.0253 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.7721 | Mean Absolute Error (lower is better) |
| MSE | 72.6196 | Mean Squared Error (lower is better) |
| RMSE | 8.5217 | Root Mean Squared Error (lower is better) |
| R2 | 0.3315 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 110.7150 |
| Final Training Loss | 73.2760 |
| Loss Improvement | 33.8% |
| Initial Validation Loss | 78.0219 |
| Final Validation Loss | 73.2507 |
| Validation Improvement | 6.1% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 637.9560 | Final epoch |
| Validation Loss | 640.3294 | Final epoch |
| Loss Gap | 2.3734 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 15.1617 | Mean Absolute Error (lower is better) |
| MSE | 637.1776 | Mean Squared Error (lower is better) |
| RMSE | 25.2424 | Root Mean Squared Error (lower is better) |
| R2 | -5.5449 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 637.9039 |
| Final Training Loss | 637.9560 |
| Loss Improvement | -0.0% |
| Initial Validation Loss | 640.0682 |
| Final Validation Loss | 640.3294 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1145069184.0000 | 1145056384.0000 | -12800.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 73.2760 | 73.2507 | -0.0253 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 637.9560 | 640.3294 | 2.3734 |
