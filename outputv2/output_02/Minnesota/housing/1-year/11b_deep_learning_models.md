...
| Average Validation Loss | 3513757444.8068 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 16534199296.0000 | Final epoch |
| Validation Loss | 17568303104.0000 | Final epoch |
| Loss Gap | 1034103808.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 38635.7891 | Mean Absolute Error (lower is better) |
| MSE | 17182242816.0000 | Mean Squared Error (lower is better) |
| RMSE | 131081.0544 | Root Mean Squared Error (lower is better) |
| R2 | -0.3852 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 34201364480.0000 |
| Final Training Loss | 16534199296.0000 |
| Loss Improvement | 51.7% |
| Initial Validation Loss | 21103667200.0000 |
| Final Validation Loss | 17568303104.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 172.0123 | Final epoch |
| Validation Loss | 173.7826 | Final epoch |
| Loss Gap | 1.7702 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.0220 | Mean Absolute Error (lower is better) |
| MSE | 172.2311 | Mean Squared Error (lower is better) |
| RMSE | 13.1237 | Root Mean Squared Error (lower is better) |
| R2 | 0.0703 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 221.7770 |
| Final Training Loss | 172.0123 |
| Loss Improvement | 22.4% |
| Initial Validation Loss | 183.9118 |
| Final Validation Loss | 173.7826 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 218.2105 | Final epoch |
| Validation Loss | 38.8504 | Final epoch |
| Loss Gap | -179.3601 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.5234 | Mean Absolute Error (lower is better) |
| MSE | 39.1482 | Mean Squared Error (lower is better) |
| RMSE | 6.2569 | Root Mean Squared Error (lower is better) |
| R2 | 0.8005 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 9592.4648 |
| Final Training Loss | 218.2105 |
| Loss Improvement | 97.7% |
| Initial Validation Loss | 90.9089 |
| Final Validation Loss | 38.8504 |
| Validation Improvement | 57.3% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 489779.2500 | Final epoch |
| Validation Loss | 483907.1562 | Final epoch |
| Loss Gap | -5872.0938 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 273.4089 | Mean Absolute Error (lower is better) |
| MSE | 502443.1875 | Mean Squared Error (lower is better) |
| RMSE | 708.8323 | Root Mean Squared Error (lower is better) |
| R2 | 0.3138 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 694515.6250 |
| Final Training Loss | 489779.2500 |
| Loss Improvement | 29.5% |
| Initial Validation Loss | 527735.7500 |
| Final Validation Loss | 483907.1562 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.2456 | Final epoch |
| Validation Loss | 0.2450 | Final epoch |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.2587 | Mean Absolute Error (lower is better) |
| MSE | 0.2454 | Mean Squared Error (lower is better) |
| RMSE | 0.4953 | Root Mean Squared Error (lower is better) |
| R2 | 0.2621 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.6672 |
| Final Training Loss | 0.2456 |
| Loss Improvement | 63.2% |
| Initial Validation Loss | 0.2848 |
| Final Validation Loss | 0.2450 |
| Validation Improvement | 14.0% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 16534199296.0000 | 17568303104.0000 | 1034103808.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 172.0123 | 173.7826 | 1.7702 |
| Housing Quality | HousingQualityModel | 10,371 | 218.2105 | 38.8504 | -179.3601 |
| Cost Prediction | HousingDefaultModel | 10,306 | 489779.2500 | 483907.1562 | -5872.0938 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.2456 | 0.2450 | -0.0006 |
