...
| R² Score | 0.1932 | Poor fit |
| RMSE | 175,668.32 | Root Mean Square Error |
| MAE | 79,836.11 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 46379.0072 | Positive |
| Number_of_Rooms | 25098.4902 | Positive |
| Housing_Unit_Weight | 20278.8241 | Positive |
| Number_of_Bedrooms | 14581.0909 | Positive |
| Number_of_Persons | 7409.8396 | Positive |
| Building_Type | 5392.8927 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2480 | Poor fit |
| RMSE | 402.24 | Root Mean Square Error |
| MAE | 259.53 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 109.3636 | Positive |
| Number_of_Bedrooms | 62.3662 | Positive |
| Housing_Unit_Weight | 57.9328 | Positive |
| Building_Type | 55.1540 | Positive |
| Number_of_Persons | 48.2040 | Positive |
| Number_of_Rooms | 38.9288 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5806 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 58,259 | 77.9% | Dominant cluster |
| Cluster 1 | 2,915 | 3.9% | Minor cluster |
| Cluster 2 | 7,827 | 10.5% | Moderate cluster |
| Cluster 3 | 2,480 | 3.3% | Minor cluster |
| Cluster 4 | 3,342 | 4.5% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 145.2%).*
...
| polynomial_degree_2 | 0.9459 | — | — | — | 2 |
| polynomial_degree_1 | 0.9044 | — | — | — | 3 |
| holt_winters | 0.7542 | — | — | — | 4 |
| sma | 0.6599 | — | — | — | 5 |
| wma | 0.6413 | — | — | — | 6 |
| arima | 0.5050 | — | — | — | 7 |
| ewma | 0.3813 | — | — | — | 8 |
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9933 | — | — | — | 1 |
| polynomial_degree_2 | 0.9864 | — | — | — | 2 |
| holt_winters | 0.9776 | — | — | — | 3 |
| wma | 0.9687 | — | — | — | 4 |
| polynomial_degree_1 | 0.9549 | — | — | — | 5 |
| sma | 0.9335 | — | — | — | 6 |
| ewma | 0.7993 | — | — | — | 7 |
| arima | -0.5918 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9933. Models are ranked by R² score.*
