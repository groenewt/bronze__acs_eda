...
| Average Validation Loss | 1531399244.3950 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 6700939264.0000 | Final epoch |
| Validation Loss | 7656862720.0000 | Final epoch |
| Loss Gap | 955923456.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 22711.7793 | Mean Absolute Error (lower is better) |
| MSE | 6282948096.0000 | Mean Squared Error (lower is better) |
| RMSE | 79265.0496 | Root Mean Squared Error (lower is better) |
| R2 | -0.5567 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 14386107392.0000 |
| Final Training Loss | 6700939264.0000 |
| Loss Improvement | 53.4% |
| Initial Validation Loss | 15042019328.0000 |
| Final Validation Loss | 7656862720.0000 |
| Validation Improvement | 49.1% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 162.1225 | Final epoch |
| Validation Loss | 161.4538 | Final epoch |
| Loss Gap | -0.6687 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 5.7145 | Mean Absolute Error (lower is better) |
| MSE | 165.5641 | Mean Squared Error (lower is better) |
| RMSE | 12.8672 | Root Mean Squared Error (lower is better) |
| R2 | 0.0452 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 249.1194 |
| Final Training Loss | 162.1225 |
| Loss Improvement | 34.9% |
| Initial Validation Loss | 174.8674 |
| Final Validation Loss | 161.4538 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 267.1612 | Final epoch |
| Validation Loss | 13.3693 | Final epoch |
| Loss Gap | -253.7919 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 1.1735 | Mean Absolute Error (lower is better) |
| MSE | 14.0714 | Mean Squared Error (lower is better) |
| RMSE | 3.7512 | Root Mean Squared Error (lower is better) |
| R2 | 0.9047 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 22639.3477 |
| Final Training Loss | 267.1612 |
| Loss Improvement | 98.8% |
| Initial Validation Loss | 9313.4844 |
| Final Validation Loss | 13.3693 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 128526.8672 | Final epoch |
| Validation Loss | 133326.7500 | Final epoch |
| Loss Gap | 4799.8828 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 148.1287 | Mean Absolute Error (lower is better) |
| MSE | 131027.4453 | Mean Squared Error (lower is better) |
| RMSE | 361.9771 | Root Mean Squared Error (lower is better) |
| R2 | 0.2394 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 231136.7188 |
| Final Training Loss | 128526.8672 |
| Loss Improvement | 44.4% |
| Initial Validation Loss | 144882.0000 |
| Final Validation Loss | 133326.7500 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.4147 | Final epoch |
| Validation Loss | 0.4020 | Final epoch |
| Loss Gap | -0.0128 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3221 | Mean Absolute Error (lower is better) |
| MSE | 0.4149 | Mean Squared Error (lower is better) |
| RMSE | 0.6442 | Root Mean Squared Error (lower is better) |
| R2 | 0.1833 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1.0372 |
| Final Training Loss | 0.4147 |
| Loss Improvement | 60.0% |
| Initial Validation Loss | 0.8196 |
| Final Validation Loss | 0.4020 |
| Validation Improvement | 51.0% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 6700939264.0000 | 7656862720.0000 | 955923456.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 162.1225 | 161.4538 | -0.6687 |
| Housing Quality | HousingQualityModel | 10,371 | 267.1612 | 13.3693 | -253.7919 |
| Cost Prediction | HousingDefaultModel | 10,306 | 128526.8672 | 133326.7500 | 4799.8828 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.4147 | 0.4020 | -0.0128 |
