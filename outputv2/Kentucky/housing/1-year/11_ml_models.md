...
| R² Score | 0.2223 | Poor fit |
| RMSE | 196,060.67 | Root Mean Square Error |
| MAE | 90,544.81 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Rooms | 39387.6616 | Positive |
| Year_Structure_Built | 29187.4597 | Positive |
| Number_of_Bedrooms | 22880.0682 | Positive |
| Building_Type | 19567.3927 | Positive |
| Number_of_Persons | 6114.9392 | Positive |
| Housing_Unit_Weight | 3988.0202 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2718 | Poor fit |
| RMSE | 344.34 | Root Mean Square Error |
| MAE | 240.17 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 77.8124 | Positive |
| Number_of_Bedrooms | 67.5606 | Positive |
| Building_Type | 51.9704 | Positive |
| Number_of_Persons | 43.7526 | Positive |
| Number_of_Rooms | 40.0367 | Positive |
| Housing_Unit_Weight | 19.5309 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.4778 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 11,890 | 79.3% | Dominant cluster |
| Cluster 1 | 735 | 4.9% | Minor cluster |
| Cluster 2 | 512 | 3.4% | Minor cluster |
| Cluster 3 | 1,385 | 9.2% | Minor cluster |
| Cluster 4 | 478 | 3.2% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 148.6%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9966 | — | — | — | 1 |
| polynomial_degree_2 | 0.9405 | — | — | — | 2 |
| polynomial_degree_1 | 0.8912 | — | — | — | 3 |
| holt_winters | 0.7342 | — | — | — | 4 |
| sma | 0.6326 | — | — | — | 5 |
| wma | 0.6057 | — | — | — | 6 |
| arima | 0.4878 | — | — | — | 7 |
| ewma | 0.3578 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9966. Models are ranked by R² score.*
...
| polynomial_degree_2 | 0.9729 | — | — | — | 2 |
| holt_winters | 0.9622 | — | — | — | 3 |
| wma | 0.9556 | — | — | — | 4 |
