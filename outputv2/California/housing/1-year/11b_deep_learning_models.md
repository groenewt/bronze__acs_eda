...
| Average Validation Loss | 23452691252.6465 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 117995847680.0000 | Final epoch |
| Validation Loss | 117262180352.0000 | Final epoch |
| Loss Gap | -733667328.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 90375.1406 | Mean Absolute Error (lower is better) |
| MSE | 117477867520.0000 | Mean Squared Error (lower is better) |
| RMSE | 342750.4450 | Root Mean Squared Error (lower is better) |
| R2 | 0.0459 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 149315878912.0000 |
| Final Training Loss | 117995847680.0000 |
| Loss Improvement | 21.0% |
| Initial Validation Loss | 122721878016.0000 |
| Final Validation Loss | 117262180352.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 276.5455 | Final epoch |
| Validation Loss | 275.2327 | Final epoch |
| Loss Gap | -1.3128 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 8.8374 | Mean Absolute Error (lower is better) |
| MSE | 275.8551 | Mean Squared Error (lower is better) |
| RMSE | 16.6089 | Root Mean Squared Error (lower is better) |
| R2 | 0.0485 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 295.0459 |
| Final Training Loss | 276.5455 |
| Loss Improvement | 6.3% |
| Initial Validation Loss | 277.2289 |
| Final Validation Loss | 275.2327 |
| Validation Improvement | 0.7% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 9.7691 | Final epoch |
| Validation Loss | 9.4121 | Final epoch |
| Loss Gap | -0.3570 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.9621 | Mean Absolute Error (lower is better) |
| MSE | 9.2242 | Mean Squared Error (lower is better) |
| RMSE | 3.0371 | Root Mean Squared Error (lower is better) |
| R2 | 0.9550 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 2611.4258 |
| Final Training Loss | 9.7691 |
| Loss Improvement | 99.6% |
| Initial Validation Loss | 58.4029 |
| Final Validation Loss | 9.4121 |
| Validation Improvement | 83.9% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 1305460.5000 | Final epoch |
| Validation Loss | 1275626.2500 | Final epoch |
| Loss Gap | -29834.2500 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 288.9788 | Mean Absolute Error (lower is better) |
| MSE | 1262250.5000 | Mean Squared Error (lower is better) |
| RMSE | 1123.4992 | Root Mean Squared Error (lower is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1497201.7500 |
| Final Training Loss | 1305460.5000 |
| Loss Improvement | 12.8% |
| Initial Validation Loss | 1369478.8750 |
| Final Validation Loss | 1275626.2500 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.3375 | Final epoch |
| Validation Loss | 0.3377 | Final epoch |
| Loss Gap | 0.0002 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3005 | Mean Absolute Error (lower is better) |
| MSE | 0.3370 | Mean Squared Error (lower is better) |
| RMSE | 0.5805 | Root Mean Squared Error (lower is better) |
| R2 | 0.2655 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.4556 |
| Final Training Loss | 0.3375 |
| Loss Improvement | 25.9% |
| Initial Validation Loss | 0.3569 |
| Final Validation Loss | 0.3377 |
| Validation Improvement | 5.4% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 117995847680.0000 | 117262180352.0000 | -733667328.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 276.5455 | 275.2327 | -1.3128 |
| Housing Quality | HousingQualityModel | 10,371 | 9.7691 | 9.4121 | -0.3570 |
| Cost Prediction | HousingDefaultModel | 10,306 | 1305460.5000 | 1275626.2500 | -29834.2500 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.3375 | 0.3377 | 0.0002 |
