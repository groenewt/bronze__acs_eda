...
| R² Score | 0.1597 | Poor fit |
| RMSE | 691,869.52 | Root Mean Square Error |
| MAE | 362,503.36 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 107192.1271 | Positive |
| Number_of_Rooms | 104493.7317 | Positive |
| Number_of_Bedrooms | 80878.9553 | Positive |
| Building_Type | 32041.1897 | Positive |
| Number_of_Persons | 30361.0995 | Positive |
| Housing_Unit_Weight | 14658.6515 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2635 | Poor fit |
| RMSE | 721.42 | Root Mean Square Error |
| MAE | 534.67 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Number_of_Bedrooms | 175.8221 | Positive |
| Year_Structure_Built | 147.0911 | Positive |
| Number_of_Persons | 71.6851 | Positive |
| Number_of_Rooms | 61.6730 | Positive |
| Building_Type | 45.1011 | Positive |
| Housing_Unit_Weight | 44.0496 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.3651 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 754,027 | 59.4% | Dominant cluster |
| Cluster 1 | 64,955 | 5.1% | Minor cluster |
| Cluster 2 | 368,646 | 29.0% | Major cluster |
| Cluster 3 | 42,042 | 3.3% | Minor cluster |
| Cluster 4 | 40,636 | 3.2% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 109.8%).*
...
| polynomial_degree_1 | 0.9684 | — | — | — | 3 |
| holt_winters | 0.8589 | — | — | — | 4 |
| sma | 0.7643 | — | — | — | 5 |
| wma | 0.7595 | — | — | — | 6 |
| arima | 0.7030 | — | — | — | 7 |
| ewma | 0.4943 | — | — | — | 8 |
