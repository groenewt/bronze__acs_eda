...
| Average Validation Loss | 1569944417.9115 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 7676179456.0000 | Final epoch |
| Validation Loss | 7849503232.0000 | Final epoch |
| Loss Gap | 173323776.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 24604.1133 | Mean Absolute Error (lower is better) |
| MSE | 7589732352.0000 | Mean Squared Error (lower is better) |
| RMSE | 87119.0700 | Root Mean Squared Error (lower is better) |
| R2 | -0.1952 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 14159569920.0000 |
| Final Training Loss | 7676179456.0000 |
| Loss Improvement | 45.8% |
| Initial Validation Loss | 8570342912.0000 |
| Final Validation Loss | 7849503232.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 181.4016 | Final epoch |
| Validation Loss | 180.3187 | Final epoch |
| Loss Gap | -1.0829 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.2469 | Mean Absolute Error (lower is better) |
| MSE | 179.0602 | Mean Squared Error (lower is better) |
| RMSE | 13.3813 | Root Mean Squared Error (lower is better) |
| R2 | 0.0578 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 219.3493 |
| Final Training Loss | 181.4016 |
| Loss Improvement | 17.3% |
| Initial Validation Loss | 184.9918 |
| Final Validation Loss | 180.3187 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 182.2507 | Final epoch |
| Validation Loss | 17.7527 | Final epoch |
| Loss Gap | -164.4980 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.9999 | Mean Absolute Error (lower is better) |
| MSE | 18.4076 | Mean Squared Error (lower is better) |
| RMSE | 4.2904 | Root Mean Squared Error (lower is better) |
| R2 | 0.7961 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 8277.5537 |
| Final Training Loss | 182.2507 |
| Loss Improvement | 97.8% |
| Initial Validation Loss | 85.2047 |
| Final Validation Loss | 17.7527 |
| Validation Improvement | 79.2% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 230994.9062 | Final epoch |
| Validation Loss | 218659.1406 | Final epoch |
| Loss Gap | -12335.7656 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 177.9482 | Mean Absolute Error (lower is better) |
| MSE | 234289.4688 | Mean Squared Error (lower is better) |
| RMSE | 484.0346 | Root Mean Squared Error (lower is better) |
| R2 | 0.2742 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 311804.4062 |
| Final Training Loss | 230994.9062 |
| Loss Improvement | 25.9% |
| Initial Validation Loss | 252762.2188 |
| Final Validation Loss | 218659.1406 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.3480 | Final epoch |
| Validation Loss | 0.3454 | Final epoch |
| Loss Gap | -0.0025 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3017 | Mean Absolute Error (lower is better) |
| MSE | 0.3467 | Mean Squared Error (lower is better) |
| RMSE | 0.5888 | Root Mean Squared Error (lower is better) |
| R2 | 0.2432 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.8160 |
| Final Training Loss | 0.3480 |
| Loss Improvement | 57.4% |
| Initial Validation Loss | 0.3776 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 7676179456.0000 | 7849503232.0000 | 173323776.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 181.4016 | 180.3187 | -1.0829 |
| Housing Quality | HousingQualityModel | 10,371 | 182.2507 | 17.7527 | -164.4980 |
| Cost Prediction | HousingDefaultModel | 10,306 | 230994.9062 | 218659.1406 | -12335.7656 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.3480 | 0.3454 | -0.0025 |
