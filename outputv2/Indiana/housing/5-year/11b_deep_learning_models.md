...
| Average Validation Loss | 25755.2197 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 13409.4502 | Final epoch |
| Validation Loss | 12426.5703 | Final epoch |
| Loss Gap | -982.8799 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 31.2084 | Mean Absolute Error (lower is better) |
| MSE | 12830.2930 | Mean Squared Error (lower is better) |
| RMSE | 113.2709 | Root Mean Squared Error (lower is better) |
| R2 | 0.0689 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 21045.9473 |
| Final Training Loss | 13409.4502 |
| Loss Improvement | 36.3% |
| Initial Validation Loss | 12845.1934 |
| Final Validation Loss | 12426.5703 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 177.8257 | Final epoch |
| Validation Loss | 177.3255 | Final epoch |
| Loss Gap | -0.5001 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.2726 | Mean Absolute Error (lower is better) |
| MSE | 177.1450 | Mean Squared Error (lower is better) |
| RMSE | 13.3096 | Root Mean Squared Error (lower is better) |
| R2 | 0.0601 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 190.8463 |
| Final Training Loss | 177.8257 |
| Loss Improvement | 6.8% |
| Initial Validation Loss | 178.5011 |
| Final Validation Loss | 177.3255 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.0048 | Final epoch |
| Validation Loss | 0.0079 | Final epoch |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.0291 | Mean Absolute Error (lower is better) |
| MSE | 0.0075 | Mean Squared Error (lower is better) |
| RMSE | 0.0867 | Root Mean Squared Error (lower is better) |
| R2 | 0.9889 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.3015 |
| Final Training Loss | 0.0048 |
| Loss Improvement | 98.4% |
| Initial Validation Loss | 0.0179 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 118322.9844 | Final epoch |
| Validation Loss | 116171.8438 | Final epoch |
| Loss Gap | -2151.1406 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 139.4356 | Mean Absolute Error (lower is better) |
| MSE | 118061.8203 | Mean Squared Error (lower is better) |
| RMSE | 343.6013 | Root Mean Squared Error (lower is better) |
| R2 | 0.1154 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 134117.7344 |
| Final Training Loss | 118322.9844 |
| Loss Improvement | 11.8% |
| Initial Validation Loss | 117617.5938 |
| Final Validation Loss | 116171.8438 |
| Validation Improvement | 1.2% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.3512 | Final epoch |
| Validation Loss | 0.3508 | Final epoch |
| Loss Gap | -0.0004 | NONE overfitting risk |
...
| MSE | 0.3482 | Mean Squared Error (lower is better) |
| RMSE | 0.5901 | Root Mean Squared Error (lower is better) |
| R2 | 0.2471 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.4660 |
| Final Training Loss | 0.3512 |
| Loss Improvement | 24.6% |
| Initial Validation Loss | 0.3638 |
| Final Validation Loss | 0.3508 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 13409.4502 | 12426.5703 | -982.8799 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 177.8257 | 177.3255 | -0.5001 |
| Housing Quality | HousingQualityModel | 10,371 | 0.0048 | 0.0079 | 0.0031 |
| Cost Prediction | HousingDefaultModel | 10,306 | 118322.9844 | 116171.8438 | -2151.1406 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.3512 | 0.3508 | -0.0004 |
