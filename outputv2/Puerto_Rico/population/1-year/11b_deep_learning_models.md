...
| Average Validation Loss | 108288927.7722 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 330595456.0000 | Final epoch |
| Validation Loss | 324866080.0000 | Final epoch |
| Loss Gap | -5729376.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 7337.0645 | Mean Absolute Error (lower is better) |
| MSE | 335039232.0000 | Mean Squared Error (lower is better) |
| RMSE | 18304.0769 | Root Mean Squared Error (lower is better) |
| R2 | 0.3150 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 437485152.0000 |
| Final Training Loss | 330595456.0000 |
| Loss Improvement | 24.4% |
| Initial Validation Loss | 385258912.0000 |
| Final Validation Loss | 324866080.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 42.2583 | Final epoch |
| Validation Loss | 42.6129 | Final epoch |
| Loss Gap | 0.3547 | MODERATE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 2.3443 | Mean Absolute Error (lower is better) |
| MSE | 42.1199 | Mean Squared Error (lower is better) |
| RMSE | 6.4900 | Root Mean Squared Error (lower is better) |
| R2 | 0.3413 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 73.8364 |
| Final Training Loss | 42.2583 |
| Loss Improvement | 42.8% |
| Initial Validation Loss | 44.1426 |
| Final Validation Loss | 42.6129 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 661.2930 | Final epoch |
| Validation Loss | 660.7036 | Final epoch |
| Loss Gap | -0.5894 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 15.4278 | Mean Absolute Error (lower is better) |
| MSE | 660.3602 | Mean Squared Error (lower is better) |
| RMSE | 25.6975 | Root Mean Squared Error (lower is better) |
| R2 | -5.3883 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 661.4012 |
| Final Training Loss | 661.2930 |
| Loss Improvement | 0.0% |
| Initial Validation Loss | 660.5151 |
| Final Validation Loss | 660.7036 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 330595456.0000 | 324866080.0000 | -5729376.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 42.2583 | 42.6129 | 0.3547 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 661.2930 | 660.7036 | -0.5894 |
