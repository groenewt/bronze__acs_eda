...
| R² Score | 0.1369 | Poor fit |
| RMSE | 336,735.79 | Root Mean Square Error |
| MAE | 160,161.79 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 83691.7508 | Positive |
| Number_of_Rooms | 40481.0814 | Positive |
| Building_Type | 33693.9296 | Positive |
| Number_of_Persons | 15689.2891 | Positive |
| Number_of_Bedrooms | 11454.7127 | Positive |
| Housing_Unit_Weight | 5529.8355 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2346 | Poor fit |
| RMSE | 408.34 | Root Mean Square Error |
| MAE | 276.52 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 99.2164 | Positive |
| Housing_Unit_Weight | 61.3645 | Positive |
| Number_of_Bedrooms | 60.5580 | Positive |
| Number_of_Persons | 52.0588 | Positive |
| Number_of_Rooms | 47.8095 | Positive |
| Building_Type | 46.8003 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.3201 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 9,439 | 62.9% | Dominant cluster |
| Cluster 1 | 1,028 | 6.9% | Minor cluster |
| Cluster 2 | 715 | 4.8% | Minor cluster |
| Cluster 3 | 1,212 | 8.1% | Minor cluster |
| Cluster 4 | 2,606 | 17.4% | Moderate cluster |



> *Cluster distribution is imbalanced (CV: 109.5%).*
...
| polynomial_degree_2 | 0.9315 | — | — | — | 2 |
| polynomial_degree_1 | 0.9306 | — | — | — | 3 |
| holt_winters | 0.8117 | — | — | — | 4 |
| wma | 0.7333 | — | — | — | 5 |
| sma | 0.7245 | — | — | — | 6 |
| arima | 0.6286 | — | — | — | 7 |
| ewma | 0.4834 | — | — | — | 8 |
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9869 | — | — | — | 1 |
| polynomial_degree_2 | 0.9680 | — | — | — | 2 |
| holt_winters | 0.9627 | — | — | — | 3 |
| wma | 0.9549 | — | — | — | 4 |
| sma | 0.9083 | — | — | — | 5 |
| polynomial_degree_1 | 0.8806 | — | — | — | 6 |
| ewma | 0.7698 | — | — | — | 7 |
| arima | -0.1809 | — | — | — | 8 |



> *The polynomial_degree_3 model achieved the best fit with R² = 0.9869. Models are ranked by R² score.*
