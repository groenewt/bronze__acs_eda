...
| Average Validation Loss | 418935368.5919 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1336975744.0000 | Final epoch |
| Validation Loss | 1256805376.0000 | Final epoch |
| Loss Gap | -80170368.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 17734.6035 | Mean Absolute Error (lower is better) |
| MSE | 1393782656.0000 | Mean Squared Error (lower is better) |
| RMSE | 37333.3987 | Root Mean Squared Error (lower is better) |
| R2 | 0.1682 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 2108070528.0000 |
| Final Training Loss | 1336975744.0000 |
| Loss Improvement | 36.6% |
| Initial Validation Loss | 1782812800.0000 |
| Final Validation Loss | 1256805376.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 78.8140 | Final epoch |
| Validation Loss | 76.6380 | Final epoch |
| Loss Gap | -2.1760 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.8714 | Mean Absolute Error (lower is better) |
| MSE | 78.2530 | Mean Squared Error (lower is better) |
| RMSE | 8.8461 | Root Mean Squared Error (lower is better) |
| R2 | 0.2796 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 169.8462 |
| Final Training Loss | 78.8140 |
| Loss Improvement | 53.6% |
| Initial Validation Loss | 85.0060 |
| Final Validation Loss | 76.6380 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 655.1258 | Final epoch |
| Validation Loss | 653.1377 | Final epoch |
| Loss Gap | -1.9881 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 15.4592 | Mean Absolute Error (lower is better) |
| MSE | 654.5367 | Mean Squared Error (lower is better) |
| RMSE | 25.5839 | Root Mean Squared Error (lower is better) |
| R2 | -5.6095 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 655.5558 |
| Final Training Loss | 655.1258 |
| Loss Improvement | 0.1% |
| Initial Validation Loss | 653.3843 |
| Final Validation Loss | 653.1377 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1336975744.0000 | 1256805376.0000 | -80170368.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 78.8140 | 76.6380 | -2.1760 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 655.1258 | 653.1377 | -1.9881 |
