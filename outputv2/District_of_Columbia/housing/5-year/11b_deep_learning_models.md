...
| Average Validation Loss | 77090.3017 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 149929.4219 | Final epoch |
| Validation Loss | 146155.2188 | Final epoch |
| Loss Gap | -3774.2031 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 147.3820 | Mean Absolute Error (lower is better) |
| MSE | 141848.7812 | Mean Squared Error (lower is better) |
| RMSE | 376.6282 | Root Mean Squared Error (lower is better) |
| R2 | 0.0763 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 405753.6250 |
| Final Training Loss | 149929.4219 |
| Loss Improvement | 63.0% |
| Initial Validation Loss | 157354.8750 |
| Final Validation Loss | 146155.2188 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 248.7041 | Final epoch |
| Validation Loss | 253.1387 | Final epoch |
| Loss Gap | 4.4345 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 7.8716 | Mean Absolute Error (lower is better) |
| MSE | 250.2509 | Mean Squared Error (lower is better) |
| RMSE | 15.8193 | Root Mean Squared Error (lower is better) |
| R2 | 0.0649 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 328.1486 |
| Final Training Loss | 248.7041 |
| Loss Improvement | 24.2% |
| Initial Validation Loss | 259.8688 |
| Final Validation Loss | 253.1387 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.0112 | Final epoch |
| Validation Loss | 0.0289 | Final epoch |
| Loss Gap | 0.0178 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.0517 | Mean Absolute Error (lower is better) |
| MSE | 0.0279 | Mean Squared Error (lower is better) |
| RMSE | 0.1670 | Root Mean Squared Error (lower is better) |
| R2 | 0.9875 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.6535 |
| Final Training Loss | 0.0112 |
| Loss Improvement | 98.3% |
| Initial Validation Loss | 0.0677 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 251184.5625 | Final epoch |
| Validation Loss | 239042.7031 | Final epoch |
| Loss Gap | -12141.8594 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 150.7162 | Mean Absolute Error (lower is better) |
| MSE | 230968.3594 | Mean Squared Error (lower is better) |
| RMSE | 480.5917 | Root Mean Squared Error (lower is better) |
| R2 | 0.1012 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 403920.8125 |
| Final Training Loss | 251184.5625 |
| Loss Improvement | 37.8% |
| Initial Validation Loss | 251018.4375 |
| Final Validation Loss | 239042.7031 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.4260 | Final epoch |
| Validation Loss | 0.4190 | Final epoch |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3286 | Mean Absolute Error (lower is better) |
| MSE | 0.4313 | Mean Squared Error (lower is better) |
| RMSE | 0.6567 | Root Mean Squared Error (lower is better) |
| R2 | 0.2510 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.9469 |
| Final Training Loss | 0.4260 |
| Loss Improvement | 55.0% |
| Initial Validation Loss | 0.4875 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 149929.4219 | 146155.2188 | -3774.2031 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 248.7041 | 253.1387 | 4.4345 |
| Housing Quality | HousingQualityModel | 10,371 | 0.0112 | 0.0289 | 0.0178 |
| Cost Prediction | HousingDefaultModel | 10,306 | 251184.5625 | 239042.7031 | -12141.8594 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.4260 | 0.4190 | -0.0071 |
