...
| R² Score | 0.2834 | Poor fit |
| RMSE | 2.34 | Root Mean Square Error |
| MAE | 1.58 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 0.5848 | Positive |
| Number_of_Rooms | 0.5652 | Positive |
| Building_Type | 0.3638 | Positive |
| Number_of_Bedrooms | 0.2757 | Positive |
| Housing_Unit_Weight | 0.2144 | Positive |
| Number_of_Persons | 0.2141 | Positive |
| Housing_Adjustment_Factor | 0.0852 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3421 | Weak fit |
| RMSE | 594.57 | Root Mean Square Error |
| MAE | 443.69 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Building_Type | 144.2338 | Positive |
| Year_Structure_Built | 129.4259 | Positive |
| Number_of_Bedrooms | 103.0577 | Positive |
| Number_of_Persons | 83.2295 | Positive |
| Housing_Adjustment_Factor | 70.6238 | Positive |
| Housing_Unit_Weight | 44.6425 | Positive |
| Number_of_Rooms | 34.0205 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.2164 | No substantial structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 12,304 | 28.6% | Major cluster |
| Cluster 1 | 4,699 | 10.9% | Moderate cluster |
| Cluster 2 | 7,012 | 16.3% | Moderate cluster |
| Cluster 3 | 13,183 | 30.7% | Major cluster |
| Cluster 4 | 5,813 | 13.5% | Moderate cluster |



> *Cluster distribution is moderately balanced (CV: 40.3%).*
...
| polynomial_degree_1 | 0.5403 | — | — | — | 3 |
| holt_winters | 0.5403 | — | — | — | 4 |
| sma | 0.0000 | — | — | — | 5 |
| wma | -0.0901 | — | — | — | 6 |
| ewma | -0.0905 | — | — | — | 7 |
| arima | -77262.1050 | — | — | — | 8 |
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9993 | — | — | — | 1 |
| holt_winters | 0.9981 | — | — | — | 2 |
| polynomial_degree_2 | 0.9958 | — | — | — | 3 |
| polynomial_degree_1 | 0.9917 | — | — | — | 4 |
| wma | 0.9676 | — | — | — | 5 |
| sma | 0.9419 | — | — | — | 6 |
| ewma | 0.7909 | — | — | — | 7 |
| arima | -0.1764 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9993. Models are ranked by R² score.*
