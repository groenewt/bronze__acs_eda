...
| R² Score | 0.1788 | Poor fit |
| RMSE | 303,755.98 | Root Mean Square Error |
| MAE | 145,216.55 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 59911.9150 | Positive |
| Number_of_Rooms | 51679.5913 | Positive |
| Number_of_Bedrooms | 30176.3555 | Positive |
| Building_Type | 27599.2942 | Positive |
| Number_of_Persons | 19453.7179 | Positive |
| Housing_Unit_Weight | 4776.6749 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.4600 | Weak fit |
| RMSE | 398.15 | Root Mean Square Error |
| MAE | 260.50 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 148.2230 | Positive |
| Number_of_Bedrooms | 107.7856 | Positive |
| Building_Type | 91.8722 | Positive |
| Number_of_Rooms | 49.0093 | Positive |
| Number_of_Persons | 28.6456 | Positive |
| Housing_Unit_Weight | 17.7842 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.3598 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 70,954 | 63.6% | Dominant cluster |
| Cluster 1 | 4,905 | 4.4% | Minor cluster |
| Cluster 2 | 27,090 | 24.3% | Major cluster |
| Cluster 3 | 5,614 | 5.0% | Minor cluster |
| Cluster 4 | 2,964 | 2.7% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 116.0%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9917 | — | — | — | 1 |
| polynomial_degree_2 | 0.9866 | — | — | — | 2 |
| polynomial_degree_1 | 0.9864 | — | — | — | 3 |
| holt_winters | 0.9173 | — | — | — | 4 |
| wma | 0.8374 | — | — | — | 5 |
| sma | 0.8230 | — | — | — | 6 |
| arima | 0.7910 | — | — | — | 7 |
| ewma | 0.5781 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9917. Models are ranked by R² score.*
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9867 | — | — | — | 1 |
| polynomial_degree_2 | 0.9676 | — | — | — | 2 |
| holt_winters | 0.9507 | — | — | — | 3 |
| wma | 0.9412 | — | — | — | 4 |
| sma | 0.8736 | — | — | — | 5 |
| ewma | 0.7185 | — | — | — | 6 |
| polynomial_degree_1 | 0.6438 | — | — | — | 7 |
| arima | -0.8550 | — | — | — | 8 |



> *The polynomial_degree_3 model achieved the best fit with R² = 0.9867. Models are ranked by R² score.*
