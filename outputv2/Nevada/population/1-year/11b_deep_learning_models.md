...
| Average Validation Loss | 595514120.0637 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1743169792.0000 | Final epoch |
| Validation Loss | 1786541696.0000 | Final epoch |
| Loss Gap | 43371904.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 19547.0234 | Mean Absolute Error (lower is better) |
| MSE | 1889331200.0000 | Mean Squared Error (lower is better) |
| RMSE | 43466.4376 | Root Mean Squared Error (lower is better) |
| R2 | 0.1866 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 2337771520.0000 |
| Final Training Loss | 1743169792.0000 |
| Loss Improvement | 25.4% |
| Initial Validation Loss | 2072355072.0000 |
| Final Validation Loss | 1786541696.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 67.1162 | Final epoch |
| Validation Loss | 66.6622 | Final epoch |
| Loss Gap | -0.4540 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.4737 | Mean Absolute Error (lower is better) |
| MSE | 66.3301 | Mean Squared Error (lower is better) |
| RMSE | 8.1443 | Root Mean Squared Error (lower is better) |
| R2 | 0.2847 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 103.3140 |
| Final Training Loss | 67.1162 |
| Loss Improvement | 35.0% |
| Initial Validation Loss | 69.4772 |
| Final Validation Loss | 66.6622 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 599.2034 | Final epoch |
| Validation Loss | 597.5290 | Final epoch |
| Loss Gap | -1.6744 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 14.8704 | Mean Absolute Error (lower is better) |
| MSE | 597.8828 | Mean Squared Error (lower is better) |
| RMSE | 24.4516 | Root Mean Squared Error (lower is better) |
| R2 | -5.4770 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 599.3244 |
| Final Training Loss | 599.2034 |
| Loss Improvement | 0.0% |
| Initial Validation Loss | 597.4694 |
| Final Validation Loss | 597.5290 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1743169792.0000 | 1786541696.0000 | 43371904.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 67.1162 | 66.6622 | -0.4540 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 599.2034 | 597.5290 | -1.6744 |
