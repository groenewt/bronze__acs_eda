...
| Average Validation Loss | 5714386525.2032 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 24169936896.0000 | Final epoch |
| Validation Loss | 28571222016.0000 | Final epoch |
| Loss Gap | 4401285120.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 40787.9531 | Mean Absolute Error (lower is better) |
| MSE | 27114631168.0000 | Mean Squared Error (lower is better) |
| RMSE | 164665.2093 | Root Mean Squared Error (lower is better) |
| R2 | -0.1585 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 68029960192.0000 |
| Final Training Loss | 24169936896.0000 |
| Loss Improvement | 64.5% |
| Initial Validation Loss | 74334543872.0000 |
| Final Validation Loss | 28571222016.0000 |
| Validation Improvement | 61.6% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 221.4475 | Final epoch |
| Validation Loss | 221.5062 | Final epoch |
| Loss Gap | 0.0587 | LOW overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 7.2102 | Mean Absolute Error (lower is better) |
| MSE | 220.3520 | Mean Squared Error (lower is better) |
| RMSE | 14.8443 | Root Mean Squared Error (lower is better) |
| R2 | 0.0582 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 470.0728 |
| Final Training Loss | 221.4475 |
| Loss Improvement | 52.9% |
| Initial Validation Loss | 295.9866 |
| Final Validation Loss | 221.5062 |
| Validation Improvement | 25.2% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 368.8401 | Final epoch |
| Validation Loss | 38.6174 | Final epoch |
| Loss Gap | -330.2227 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 1.9896 | Mean Absolute Error (lower is better) |
| MSE | 44.1000 | Mean Squared Error (lower is better) |
| RMSE | 6.6408 | Root Mean Squared Error (lower is better) |
| R2 | 0.8405 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 35454.1484 |
| Final Training Loss | 368.8401 |
| Loss Improvement | 99.0% |
| Initial Validation Loss | 18136.7031 |
| Final Validation Loss | 38.6174 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 752372.0625 | Final epoch |
| Validation Loss | 710349.5625 | Final epoch |
| Loss Gap | -42022.5000 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 275.7068 | Mean Absolute Error (lower is better) |
| MSE | 640651.8750 | Mean Squared Error (lower is better) |
| RMSE | 800.4073 | Root Mean Squared Error (lower is better) |
| R2 | 0.3156 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1695835.2500 |
| Final Training Loss | 752372.0625 |
| Loss Improvement | 55.6% |
| Initial Validation Loss | 1593879.5000 |
| Final Validation Loss | 710349.5625 |
| Validation Improvement | 55.4% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.3422 | Final epoch |
| Validation Loss | 0.3298 | Final epoch |
| Loss Gap | -0.0124 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.2897 | Mean Absolute Error (lower is better) |
| MSE | 0.3272 | Mean Squared Error (lower is better) |
| RMSE | 0.5720 | Root Mean Squared Error (lower is better) |
| R2 | 0.2426 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1.4981 |
| Final Training Loss | 0.3422 |
| Loss Improvement | 77.2% |
| Initial Validation Loss | 1.5305 |
| Final Validation Loss | 0.3298 |
| Validation Improvement | 78.5% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 24169936896.0000 | 28571222016.0000 | 4401285120.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 221.4475 | 221.5062 | 0.0587 |
| Housing Quality | HousingQualityModel | 10,371 | 368.8401 | 38.6174 | -330.2227 |
| Cost Prediction | HousingDefaultModel | 10,306 | 752372.0625 | 710349.5625 | -42022.5000 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.3422 | 0.3298 | -0.0124 |
