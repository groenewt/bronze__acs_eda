...
| :--- | :--- | :--- |
| Best Model | linear | — |
| R² Score | 0.1284 | Poor fit |
| RMSE | 305,478.59 | Root Mean Square Error |
| MAE | 151,272.00 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Rooms | 120289.0056 | 1 |
| Number_of_Bedrooms | 19255.1600 | 2 |
| Number_of_Persons | 11746.7578 | 3 |
| Housing_Unit_Weight | 5776.0484 | 4 |
| Building_Type | 1705.2399 | 5 |
| Year_Structure_Built | 487.1413 | 6 |
| Census_Region | 0.0000 | 7 |
| Housing_Unit_Type | 0.0000 | 8 |
| Housing_Adjustment_Factor | 0.0000 | 9 |
...
| R² Score | 0.2766 | Poor fit |
| RMSE | 476.60 | Root Mean Square Error |
| MAE | 342.99 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| :--- | :--- | :--- |
| Number_of_Bedrooms | 113.9307 | Positive |
| Year_Structure_Built | 100.5497 | Positive |
| Building_Type | 78.2667 | Positive |
| Number_of_Persons | 66.0171 | Positive |
| Number_of_Rooms | 61.3998 | Positive |
| Housing_Unit_Weight | 30.2665 | Positive |
...
| Silhouette Score | 0.3174 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 19,416 | 46.6% | Dominant cluster |
| Cluster 1 | 1,847 | 4.4% | Minor cluster |
| Cluster 2 | 13,878 | 33.3% | Major cluster |
| Cluster 3 | 3,905 | 9.4% | Minor cluster |
| Cluster 4 | 2,599 | 6.2% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 84.6%).*
...
| polynomial_degree_2 | 0.8985 | — | — | — | 2 |
| polynomial_degree_1 | 0.8780 | — | — | — | 3 |
| holt_winters | 0.7220 | — | — | — | 4 |
| sma | 0.6300 | — | — | — | 5 |
| wma | 0.6187 | — | — | — | 6 |
| arima | 0.4516 | — | — | — | 7 |
| ewma | 0.3708 | — | — | — | 8 |
...
| polynomial_degree_2 | 0.9713 | — | — | — | 2 |
| holt_winters | 0.9595 | — | — | — | 3 |
| wma | 0.9552 | — | — | — | 4 |
| sma | 0.9077 | — | — | — | 5 |
| polynomial_degree_1 | 0.8576 | — | — | — | 6 |
| ewma | 0.7700 | — | — | — | 7 |
| arima | -0.8420 | — | — | — | 8 |
