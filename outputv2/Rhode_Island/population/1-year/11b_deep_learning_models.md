...
| Average Validation Loss | 635138071.1648 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1979208832.0000 | Final epoch |
| Validation Loss | 1905413504.0000 | Final epoch |
| Loss Gap | -73795328.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 21938.9746 | Mean Absolute Error (lower is better) |
| MSE | 2019074176.0000 | Mean Squared Error (lower is better) |
| RMSE | 44934.1093 | Root Mean Squared Error (lower is better) |
| R2 | 0.2107 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 3366645248.0000 |
| Final Training Loss | 1979208832.0000 |
| Loss Improvement | 41.2% |
| Initial Validation Loss | 2826345728.0000 |
| Final Validation Loss | 1905413504.0000 |
| Validation Improvement | 32.6% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 69.9881 | Final epoch |
| Validation Loss | 70.1123 | Final epoch |
| Loss Gap | 0.1242 | LOW overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.7768 | Mean Absolute Error (lower is better) |
| MSE | 72.0323 | Mean Squared Error (lower is better) |
| RMSE | 8.4872 | Root Mean Squared Error (lower is better) |
| R2 | 0.3080 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 146.4663 |
| Final Training Loss | 69.9881 |
| Loss Improvement | 52.2% |
| Initial Validation Loss | 79.3760 |
| Final Validation Loss | 70.1123 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 644.8976 | Final epoch |
| Validation Loss | 639.3821 | Final epoch |
| Loss Gap | -5.5156 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 15.4782 | Mean Absolute Error (lower is better) |
| MSE | 643.5392 | Mean Squared Error (lower is better) |
| RMSE | 25.3681 | Root Mean Squared Error (lower is better) |
| R2 | -5.7060 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 645.9146 |
| Final Training Loss | 644.8976 |
| Loss Improvement | 0.2% |
| Initial Validation Loss | 639.5925 |
| Final Validation Loss | 639.3821 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1979208832.0000 | 1905413504.0000 | -73795328.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 69.9881 | 70.1123 | 0.1242 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 644.8976 | 639.3821 | -5.5156 |
