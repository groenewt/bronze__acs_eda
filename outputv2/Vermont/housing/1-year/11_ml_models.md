...
| R² Score | 0.1072 | Poor fit |
| RMSE | 249,210.30 | Root Mean Square Error |
| MAE | 122,914.67 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Rooms | 45269.1312 | Positive |
| Year_Structure_Built | 40894.1363 | Positive |
| Building_Type | 18882.9565 | Positive |
| Number_of_Bedrooms | 17649.7520 | Positive |
| Number_of_Persons | 13736.8373 | Positive |
| Housing_Unit_Weight | 4923.8751 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.1942 | Poor fit |
| RMSE | 453.87 | Root Mean Square Error |
| MAE | 313.91 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Number_of_Bedrooms | 92.9375 | Positive |
| Year_Structure_Built | 87.0288 | Positive |
| Number_of_Persons | 83.6716 | Positive |
| Building_Type | 64.1811 | Positive |
| Housing_Unit_Weight | 44.0960 | Positive |
| Number_of_Rooms | 42.6581 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.3897 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 11,019 | 73.5% | Dominant cluster |
| Cluster 1 | 2,256 | 15.0% | Moderate cluster |
| Cluster 2 | 494 | 3.3% | Minor cluster |
| Cluster 3 | 530 | 3.5% | Minor cluster |
| Cluster 4 | 701 | 4.7% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 135.4%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9934 | — | — | — | 1 |
| polynomial_degree_2 | 0.8851 | — | — | — | 2 |
| polynomial_degree_1 | 0.7914 | — | — | — | 3 |
| holt_winters | 0.6045 | — | — | — | 4 |
| sma | 0.5218 | — | — | — | 5 |
| wma | 0.4791 | — | — | — | 6 |
| ewma | 0.2399 | — | — | — | 7 |
| arima | 0.1180 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9934. Models are ranked by R² score.*
...
| wma | 0.9538 | — | — | — | 2 |
| polynomial_degree_2 | 0.9536 | — | — | — | 3 |
| holt_winters | 0.9458 | — | — | — | 4 |
| sma | 0.9058 | — | — | — | 5 |
| polynomial_degree_1 | 0.9033 | — | — | — | 6 |
| ewma | 0.7664 | — | — | — | 7 |
| arima | -1.5517 | — | — | — | 8 |
