...
| Average Validation Loss | 40643.7537 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 24925.3125 | Final epoch |
| Validation Loss | 24015.7227 | Final epoch |
| Loss Gap | -909.5898 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 48.2083 | Mean Absolute Error (lower is better) |
| MSE | 23821.9082 | Mean Squared Error (lower is better) |
| RMSE | 154.3435 | Root Mean Squared Error (lower is better) |
| R2 | 0.1128 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 34007.8633 |
| Final Training Loss | 24925.3125 |
| Loss Improvement | 26.7% |
| Initial Validation Loss | 24884.8262 |
| Final Validation Loss | 24015.7227 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 213.3668 | Final epoch |
| Validation Loss | 213.5830 | Final epoch |
| Loss Gap | 0.2162 | MODERATE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.9988 | Mean Absolute Error (lower is better) |
| MSE | 212.8154 | Mean Squared Error (lower is better) |
| RMSE | 14.5882 | Root Mean Squared Error (lower is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 225.9654 |
| Final Training Loss | 213.3668 |
| Loss Improvement | 5.6% |
| Initial Validation Loss | 214.9985 |
| Final Validation Loss | 213.5830 |
...
| Validation Loss | 0.0329 | Final epoch |
| Loss Gap | 0.0278 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.0804 | Mean Absolute Error (lower is better) |
| MSE | 0.0331 | Mean Squared Error (lower is better) |
| RMSE | 0.1820 | Root Mean Squared Error (lower is better) |
| R2 | 0.9920 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.1779 |
| Final Training Loss | 0.0051 |
| Loss Improvement | 97.1% |
| Initial Validation Loss | 0.0174 |
| Final Validation Loss | 0.0329 |
| Validation Improvement | -88.6% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 180085.8906 | Final epoch |
| Validation Loss | 178989.0156 | Final epoch |
| Loss Gap | -1096.8750 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 161.0159 | Mean Absolute Error (lower is better) |
| MSE | 181527.3438 | Mean Squared Error (lower is better) |
| RMSE | 426.0603 | Root Mean Squared Error (lower is better) |
| R2 | 0.1250 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 198574.5156 |
| Final Training Loss | 180085.8906 |
| Loss Improvement | 9.3% |
| Initial Validation Loss | 182843.9219 |
| Final Validation Loss | 178989.0156 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.4170 | Final epoch |
| Validation Loss | 0.4145 | Final epoch |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3202 | Mean Absolute Error (lower is better) |
| MSE | 0.4161 | Mean Squared Error (lower is better) |
| RMSE | 0.6451 | Root Mean Squared Error (lower is better) |
| R2 | 0.2494 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.4917 |
| Final Training Loss | 0.4170 |
| Loss Improvement | 15.2% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 24925.3125 | 24015.7227 | -909.5898 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 213.3668 | 213.5830 | 0.2162 |
| Housing Quality | HousingQualityModel | 10,371 | 0.0051 | 0.0329 | 0.0278 |
| Cost Prediction | HousingDefaultModel | 10,306 | 180085.8906 | 178989.0156 | -1096.8750 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.4170 | 0.4145 | -0.0025 |
