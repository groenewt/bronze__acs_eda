...
| R² Score | 0.2193 | Poor fit |
| RMSE | 206,555.52 | Root Mean Square Error |
| MAE | 104,396.70 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 39181.2310 | Positive |
| Number_of_Rooms | 35378.0908 | Positive |
| Number_of_Bedrooms | 32215.7729 | Positive |
| Housing_Unit_Weight | 16232.0791 | Positive |
| Building_Type | 12916.9296 | Positive |
| Number_of_Persons | 7360.0560 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2489 | Poor fit |
| RMSE | 477.91 | Root Mean Square Error |
| MAE | 332.02 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 103.0251 | Positive |
| Number_of_Bedrooms | 86.2963 | Positive |
| Number_of_Persons | 77.5160 | Positive |
| Building_Type | 69.9080 | Positive |
| Housing_Unit_Weight | 55.8885 | Positive |
| Number_of_Rooms | 24.9486 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.2944 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 285,792 | 56.1% | Dominant cluster |
| Cluster 1 | 27,444 | 5.4% | Minor cluster |
| Cluster 2 | 30,956 | 6.1% | Minor cluster |
| Cluster 3 | 53,149 | 10.4% | Moderate cluster |
| Cluster 4 | 111,891 | 22.0% | Major cluster |



> *Cluster distribution is imbalanced (CV: 95.1%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9951 | — | — | — | 1 |
| polynomial_degree_2 | 0.9201 | — | — | — | 2 |
| polynomial_degree_1 | 0.8300 | — | — | — | 3 |
| holt_winters | 0.6515 | — | — | — | 4 |
| sma | 0.5654 | — | — | — | 5 |
| wma | 0.5288 | — | — | — | 6 |
| arima | 0.3607 | — | — | — | 7 |
| ewma | 0.2765 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9951. Models are ranked by R² score.*
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9935 | — | — | — | 1 |
| polynomial_degree_2 | 0.9771 | — | — | — | 2 |
| holt_winters | 0.9733 | — | — | — | 3 |
| wma | 0.9587 | — | — | — | 4 |
| polynomial_degree_1 | 0.9350 | — | — | — | 5 |
| sma | 0.9206 | — | — | — | 6 |
| ewma | 0.7816 | — | — | — | 7 |
| arima | -0.6224 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9935. Models are ranked by R² score.*
