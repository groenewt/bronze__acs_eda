...
| R² Score | 0.1701 | Poor fit |
| RMSE | 276,109.07 | Root Mean Square Error |
| MAE | 126,745.91 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 75857.6449 | Positive |
| Number_of_Rooms | 35201.8507 | Positive |
| Building_Type | 19647.6161 | Positive |
| Number_of_Persons | 15218.3864 | Positive |
| Number_of_Bedrooms | 8156.6630 | Positive |
| Housing_Unit_Weight | 6893.0694 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3817 | Weak fit |
| RMSE | 376.41 | Root Mean Square Error |
| MAE | 247.97 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 127.7957 | Positive |
| Number_of_Bedrooms | 84.0950 | Positive |
| Building_Type | 76.0152 | Positive |
| Housing_Unit_Weight | 48.3354 | Positive |
| Number_of_Persons | 33.3733 | Positive |
| Number_of_Rooms | 30.8102 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5058 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 11,832 | 78.9% | Dominant cluster |
| Cluster 1 | 717 | 4.8% | Minor cluster |
| Cluster 2 | 452 | 3.0% | Minor cluster |
| Cluster 3 | 1,255 | 8.4% | Minor cluster |
| Cluster 4 | 744 | 5.0% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 147.5%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9850 | — | — | — | 1 |
| polynomial_degree_2 | 0.9353 | — | — | — | 2 |
| polynomial_degree_1 | 0.9176 | — | — | — | 3 |
| holt_winters | 0.8409 | — | — | — | 4 |
| wma | 0.8236 | — | — | — | 5 |
| sma | 0.7917 | — | — | — | 6 |
| arima | 0.7679 | — | — | — | 7 |
| ewma | 0.5778 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9850. Models are ranked by R² score.*
...
| polynomial_degree_2 | 0.9410 | — | — | — | 2 |
| wma | 0.9403 | — | — | — | 3 |
| holt_winters | 0.9385 | — | — | — | 4 |
| sma | 0.8752 | — | — | — | 5 |
| polynomial_degree_1 | 0.7663 | — | — | — | 6 |
| ewma | 0.7341 | — | — | — | 7 |
| arima | 0.0646 | — | — | — | 8 |
