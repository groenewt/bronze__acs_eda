...
| Average Validation Loss | 397138393.8724 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1257895680.0000 | Final epoch |
| Validation Loss | 1191414528.0000 | Final epoch |
| Loss Gap | -66481152.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 16376.8076 | Mean Absolute Error (lower is better) |
| MSE | 1271532416.0000 | Mean Squared Error (lower is better) |
| RMSE | 35658.5532 | Root Mean Squared Error (lower is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1829974016.0000 |
| Final Training Loss | 1257895680.0000 |
| Loss Improvement | 31.3% |
| Initial Validation Loss | 1434834432.0000 |
| Final Validation Loss | 1191414528.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 73.7219 | Final epoch |
| Validation Loss | 71.6258 | Final epoch |
| Loss Gap | -2.0961 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.7956 | Mean Absolute Error (lower is better) |
| MSE | 73.9793 | Mean Squared Error (lower is better) |
| RMSE | 8.6011 | Root Mean Squared Error (lower is better) |
| R2 | 0.2926 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 132.4140 |
| Final Training Loss | 73.7219 |
| Loss Improvement | 44.3% |
| Initial Validation Loss | 75.0888 |
| Final Validation Loss | 71.6258 |
| Validation Improvement | 4.6% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 584.5531 | Final epoch |
| Validation Loss | 581.9915 | Final epoch |
| Loss Gap | -2.5616 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 14.4687 | Mean Absolute Error (lower is better) |
| MSE | 581.5950 | Mean Squared Error (lower is better) |
| RMSE | 24.1163 | Root Mean Squared Error (lower is better) |
| R2 | -5.1772 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 584.8838 |
| Final Training Loss | 584.5531 |
| Loss Improvement | 0.1% |
| Initial Validation Loss | 582.0613 |
| Final Validation Loss | 581.9915 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1257895680.0000 | 1191414528.0000 | -66481152.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 73.7219 | 71.6258 | -2.0961 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 584.5531 | 581.9915 | -2.5616 |
