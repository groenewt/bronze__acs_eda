...
| Average Validation Loss | 811902599.4740 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 2399013632.0000 | Final epoch |
| Validation Loss | 2435707136.0000 | Final epoch |
| Loss Gap | 36693504.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 23311.0098 | Mean Absolute Error (lower is better) |
| MSE | 2403336192.0000 | Mean Squared Error (lower is better) |
| RMSE | 49023.8329 | Root Mean Squared Error (lower is better) |
| R2 | 0.1958 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 3023649792.0000 |
| Final Training Loss | 2399013632.0000 |
| Loss Improvement | 20.7% |
| Initial Validation Loss | 2764121856.0000 |
| Final Validation Loss | 2435707136.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 75.4716 | Final epoch |
| Validation Loss | 75.7876 | Final epoch |
| Loss Gap | 0.3159 | MODERATE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.8692 | Mean Absolute Error (lower is better) |
| MSE | 74.8240 | Mean Squared Error (lower is better) |
| RMSE | 8.6501 | Root Mean Squared Error (lower is better) |
| R2 | 0.2925 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 99.3075 |
| Final Training Loss | 75.4716 |
| Loss Improvement | 24.0% |
| Initial Validation Loss | 78.7405 |
| Final Validation Loss | 75.7876 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 590.0784 | Final epoch |
| Validation Loss | 586.6344 | Final epoch |
| Loss Gap | -3.4440 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 14.8979 | Mean Absolute Error (lower is better) |
| MSE | 589.8072 | Mean Squared Error (lower is better) |
| RMSE | 24.2859 | Root Mean Squared Error (lower is better) |
| R2 | -5.5378 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 589.8439 |
| Final Training Loss | 590.0784 |
| Loss Improvement | -0.0% |
| Initial Validation Loss | 586.2869 |
| Final Validation Loss | 586.6344 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 2399013632.0000 | 2435707136.0000 | 36693504.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 75.4716 | 75.7876 | 0.3159 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 590.0784 | 586.6344 | -3.4440 |
