...
| Average Validation Loss | 713237626.7146 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 2151328512.0000 | Final epoch |
| Validation Loss | 2139712128.0000 | Final epoch |
| Loss Gap | -11616384.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 19849.9551 | Mean Absolute Error (lower is better) |
| MSE | 2133544320.0000 | Mean Squared Error (lower is better) |
| RMSE | 46190.3055 | Root Mean Squared Error (lower is better) |
| R2 | 0.2000 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 2343261952.0000 |
| Final Training Loss | 2151328512.0000 |
| Loss Improvement | 8.2% |
| Initial Validation Loss | 2235457280.0000 |
| Final Validation Loss | 2139712128.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 64.5971 | Final epoch |
| Validation Loss | 64.4966 | Final epoch |
| Loss Gap | -0.1005 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.2852 | Mean Absolute Error (lower is better) |
| MSE | 64.0674 | Mean Squared Error (lower is better) |
| RMSE | 8.0042 | Root Mean Squared Error (lower is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 73.7687 |
| Final Training Loss | 64.5971 |
| Loss Improvement | 12.4% |
| Initial Validation Loss | 65.5624 |
| Final Validation Loss | 64.4966 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 687.4167 | Final epoch |
| Validation Loss | 687.6473 | Final epoch |
| Loss Gap | 0.2306 | MODERATE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 15.8959 | Mean Absolute Error (lower is better) |
| MSE | 687.4748 | Mean Squared Error (lower is better) |
| RMSE | 26.2197 | Root Mean Squared Error (lower is better) |
| R2 | -5.7788 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 686.6505 |
| Final Training Loss | 687.4167 |
| Loss Improvement | -0.1% |
| Initial Validation Loss | 686.8206 |
| Final Validation Loss | 687.6473 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 2151328512.0000 | 2139712128.0000 | -11616384.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 64.5971 | 64.4966 | -0.1005 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 687.4167 | 687.6473 | 0.2306 |
