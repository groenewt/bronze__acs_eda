...
| R² Score | 0.2144 | Poor fit |
| RMSE | 298,820.25 | Root Mean Square Error |
| MAE | 139,469.86 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 55163.6766 | Positive |
| Number_of_Rooms | 53693.9073 | Positive |
| Number_of_Bedrooms | 31836.1825 | Positive |
| Building_Type | 29088.0553 | Positive |
| Number_of_Persons | 20060.2922 | Positive |
| Housing_Unit_Weight | 8603.9010 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3717 | Weak fit |
| RMSE | 467.74 | Root Mean Square Error |
| MAE | 305.88 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 146.5551 | Positive |
| Number_of_Bedrooms | 105.1325 | Positive |
| Building_Type | 67.4102 | Positive |
| Number_of_Rooms | 64.8317 | Positive |
| Housing_Unit_Weight | 29.3630 | Positive |
| Number_of_Persons | 21.9151 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5114 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 198,727 | 73.8% | Dominant cluster |
| Cluster 1 | 11,998 | 4.5% | Minor cluster |
| Cluster 2 | 10,984 | 4.1% | Minor cluster |
| Cluster 3 | 38,016 | 14.1% | Moderate cluster |
| Cluster 4 | 9,414 | 3.5% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 136.0%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9927 | — | — | — | 1 |
| polynomial_degree_2 | 0.9465 | — | — | — | 2 |
| polynomial_degree_1 | 0.9453 | — | — | — | 3 |
| holt_winters | 0.8508 | — | — | — | 4 |
| wma | 0.7899 | — | — | — | 5 |
| sma | 0.7713 | — | — | — | 6 |
| arima | 0.7272 | — | — | — | 7 |
| ewma | 0.5383 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9927. Models are ranked by R² score.*
