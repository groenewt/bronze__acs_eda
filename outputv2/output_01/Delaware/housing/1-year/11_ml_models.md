...
| R² Score | 0.1530 | Poor fit |
| RMSE | 271,818.53 | Root Mean Square Error |
| MAE | 130,374.44 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Bedrooms | 55333.3012 | Positive |
| Year_Structure_Built | 36970.7851 | Positive |
| Building_Type | 31128.9079 | Positive |
| Number_of_Rooms | 30983.4060 | Positive |
| Housing_Unit_Weight | 26665.8655 | Positive |
| Number_of_Persons | 21527.0316 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2852 | Poor fit |
| RMSE | 447.40 | Root Mean Square Error |
| MAE | 316.52 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 118.7335 | Positive |
| Number_of_Rooms | 89.9582 | Positive |
| Number_of_Bedrooms | 77.4126 | Positive |
| Building_Type | 51.9587 | Positive |
| Number_of_Persons | 43.7186 | Positive |
| Housing_Unit_Weight | 16.9394 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5389 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 29,589 | 76.4% | Dominant cluster |
| Cluster 1 | 1,656 | 4.3% | Minor cluster |
| Cluster 2 | 4,445 | 11.5% | Moderate cluster |
| Cluster 3 | 1,373 | 3.5% | Minor cluster |
| Cluster 4 | 1,686 | 4.4% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 141.6%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9884 | — | — | — | 1 |
| polynomial_degree_2 | 0.9173 | — | — | — | 2 |
| polynomial_degree_1 | 0.8582 | — | — | — | 3 |
| holt_winters | 0.6937 | — | — | — | 4 |
| sma | 0.5958 | — | — | — | 5 |
| wma | 0.5700 | — | — | — | 6 |
| arima | 0.4185 | — | — | — | 7 |
| ewma | 0.3242 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9884. Models are ranked by R² score.*
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9837 | — | — | — | 1 |
| polynomial_degree_2 | 0.9616 | — | — | — | 2 |
| wma | 0.9456 | — | — | — | 3 |
| holt_winters | 0.9305 | — | — | — | 4 |
| sma | 0.8996 | — | — | — | 5 |
| polynomial_degree_1 | 0.8639 | — | — | — | 6 |
| ewma | 0.7616 | — | — | — | 7 |
| arima | -1.4767 | — | — | — | 8 |



> *The polynomial_degree_3 model achieved the best fit with R² = 0.9837. Models are ranked by R² score.*
