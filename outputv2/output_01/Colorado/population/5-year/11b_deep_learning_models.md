...
| Average Validation Loss | 713996747.0700 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 2186832896.0000 | Final epoch |
| Validation Loss | 2141989632.0000 | Final epoch |
| Loss Gap | -44843264.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 22106.1738 | Mean Absolute Error (lower is better) |
| MSE | 2153402624.0000 | Mean Squared Error (lower is better) |
| RMSE | 46404.7694 | Root Mean Squared Error (lower is better) |
| R2 | 0.2137 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 2406655488.0000 |
| Final Training Loss | 2186832896.0000 |
| Loss Improvement | 9.1% |
| Initial Validation Loss | 2257957632.0000 |
| Final Validation Loss | 2141989632.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 30.9827 | Final epoch |
| Validation Loss | 30.2125 | Final epoch |
| Loss Gap | -0.7703 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 2.2254 | Mean Absolute Error (lower is better) |
| MSE | 30.6917 | Mean Squared Error (lower is better) |
| RMSE | 5.5400 | Root Mean Squared Error (lower is better) |
| R2 | 0.3316 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 38.6825 |
| Final Training Loss | 30.9827 |
| Loss Improvement | 19.9% |
| Initial Validation Loss | 31.3828 |
| Final Validation Loss | 30.2125 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 578.6774 | Final epoch |
| Validation Loss | 578.9975 | Final epoch |
| Loss Gap | 0.3201 | MODERATE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 14.5984 | Mean Absolute Error (lower is better) |
| MSE | 578.0814 | Mean Squared Error (lower is better) |
| RMSE | 24.0433 | Root Mean Squared Error (lower is better) |
| R2 | -5.1680 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 577.4531 |
| Final Training Loss | 578.6774 |
| Loss Improvement | -0.2% |
| Initial Validation Loss | 577.7261 |
| Final Validation Loss | 578.9975 |
| Validation Improvement | -0.2% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 2186832896.0000 | 2141989632.0000 | -44843264.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 30.9827 | 30.2125 | -0.7703 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 578.6774 | 578.9975 | 0.3201 |
