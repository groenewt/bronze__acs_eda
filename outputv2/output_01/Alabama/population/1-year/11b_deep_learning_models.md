...
| Average Validation Loss | 417091986.4594 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1201005568.0000 | Final epoch |
| Validation Loss | 1251275264.0000 | Final epoch |
| Loss Gap | 50269696.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 16150.6250 | Mean Absolute Error (lower is better) |
| MSE | 1205470592.0000 | Mean Squared Error (lower is better) |
| RMSE | 34719.8876 | Root Mean Squared Error (lower is better) |
| R2 | 0.2549 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1509992832.0000 |
| Final Training Loss | 1201005568.0000 |
| Loss Improvement | 20.5% |
| Initial Validation Loss | 1407680768.0000 |
| Final Validation Loss | 1251275264.0000 |
| Validation Improvement | 11.1% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 61.7734 | Final epoch |
| Validation Loss | 62.3781 | Final epoch |
| Loss Gap | 0.6048 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.1852 | Mean Absolute Error (lower is better) |
| MSE | 61.8498 | Mean Squared Error (lower is better) |
| RMSE | 7.8645 | Root Mean Squared Error (lower is better) |
| R2 | 0.3116 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 86.4912 |
| Final Training Loss | 61.7734 |
| Loss Improvement | 28.6% |
| Initial Validation Loss | 64.6308 |
| Final Validation Loss | 62.3781 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 633.3613 | Final epoch |
| Validation Loss | 632.9999 | Final epoch |
| Loss Gap | -0.3614 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 15.2111 | Mean Absolute Error (lower is better) |
| MSE | 633.7536 | Mean Squared Error (lower is better) |
| RMSE | 25.1745 | Root Mean Squared Error (lower is better) |
| R2 | -5.5997 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 633.2148 |
| Final Training Loss | 633.3613 |
| Loss Improvement | -0.0% |
| Initial Validation Loss | 632.7061 |
| Final Validation Loss | 632.9999 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1201005568.0000 | 1251275264.0000 | 50269696.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 61.7734 | 62.3781 | 0.6048 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 633.3613 | 632.9999 | -0.3614 |
