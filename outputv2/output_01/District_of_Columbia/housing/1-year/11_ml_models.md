...
| R² Score | 0.2225 | Poor fit |
| RMSE | 602,354.06 | Root Mean Square Error |
| MAE | 323,267.99 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Bedrooms | 110049.9956 | Positive |
| Number_of_Rooms | 106114.0218 | Positive |
| Year_Structure_Built | 78375.1515 | Positive |
| Number_of_Persons | 37106.9580 | Positive |
| Building_Type | 35641.3461 | Positive |
| Housing_Unit_Weight | 29675.7247 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3492 | Weak fit |
| RMSE | 783.61 | Root Mean Square Error |
| MAE | 571.72 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 247.4853 | Positive |
| Building_Type | 187.9189 | Positive |
| Number_of_Persons | 159.8431 | Positive |
| Number_of_Bedrooms | 144.3447 | Positive |
| Housing_Unit_Weight | 60.0749 | Positive |
| Number_of_Rooms | 35.7416 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.3375 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 15,621 | 55.2% | Dominant cluster |
| Cluster 1 | 2,409 | 8.5% | Minor cluster |
| Cluster 2 | 5,826 | 20.6% | Major cluster |
| Cluster 3 | 969 | 3.4% | Minor cluster |
| Cluster 4 | 3,455 | 12.2% | Moderate cluster |



> *Cluster distribution is imbalanced (CV: 92.4%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9937 | — | — | — | 1 |
| polynomial_degree_2 | 0.9454 | — | — | — | 2 |
| polynomial_degree_1 | 0.8624 | — | — | — | 3 |
| holt_winters | 0.7014 | — | — | — | 4 |
| sma | 0.6182 | — | — | — | 5 |
| wma | 0.5893 | — | — | — | 6 |
| arima | 0.4672 | — | — | — | 7 |
| ewma | 0.3272 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9937. Models are ranked by R² score.*
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9916 | — | — | — | 1 |
| polynomial_degree_2 | 0.9838 | — | — | — | 2 |
| holt_winters | 0.9721 | — | — | — | 3 |
| polynomial_degree_1 | 0.9664 | — | — | — | 4 |
| wma | 0.9646 | — | — | — | 5 |
| sma | 0.9312 | — | — | — | 6 |
| ewma | 0.7962 | — | — | — | 7 |
| arima | 0.2327 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9916. Models are ranked by R² score.*
