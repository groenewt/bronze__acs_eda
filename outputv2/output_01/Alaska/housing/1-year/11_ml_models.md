...
| R² Score | 0.2427 | Poor fit |
| RMSE | 169,477.92 | Root Mean Square Error |
| MAE | 103,933.04 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Rooms | 49451.5700 | Positive |
| Housing_Unit_Weight | 31492.2162 | Positive |
| Year_Structure_Built | 29951.8746 | Positive |
| Building_Type | 12373.3218 | Positive |
| Number_of_Persons | 9993.3530 | Positive |
| Number_of_Bedrooms | 8490.1258 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3730 | Weak fit |
| RMSE | 487.96 | Root Mean Square Error |
| MAE | 350.83 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Housing_Unit_Weight | 141.7888 | Positive |
| Number_of_Rooms | 114.1494 | Positive |
| Number_of_Bedrooms | 103.7725 | Positive |
| Building_Type | 73.4218 | Positive |
| Year_Structure_Built | 56.9934 | Positive |
| Number_of_Persons | 45.4044 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.3018 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 9,797 | 34.6% | Major cluster |
| Cluster 1 | 1,987 | 7.0% | Minor cluster |
| Cluster 2 | 3,524 | 12.5% | Moderate cluster |
| Cluster 3 | 1,310 | 4.6% | Minor cluster |
| Cluster 4 | 11,670 | 41.3% | Dominant cluster |



> *Cluster distribution is imbalanced (CV: 75.1%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9809 | — | — | — | 1 |
| polynomial_degree_2 | 0.9117 | — | — | — | 2 |
| polynomial_degree_1 | 0.8133 | — | — | — | 3 |
| holt_winters | 0.6288 | — | — | — | 4 |
| sma | 0.5365 | — | — | — | 5 |
| wma | 0.4902 | — | — | — | 6 |
| arima | 0.3399 | — | — | — | 7 |
| ewma | 0.2607 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9809. Models are ranked by R² score.*
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9520 | — | — | — | 1 |
| wma | 0.9370 | — | — | — | 2 |
| polynomial_degree_2 | 0.9368 | — | — | — | 3 |
| polynomial_degree_1 | 0.9331 | — | — | — | 4 |
| holt_winters | 0.9245 | — | — | — | 5 |
| sma | 0.9032 | — | — | — | 6 |
| ewma | 0.7689 | — | — | — | 7 |
| arima | -3.0847 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9520. Models are ranked by R² score.*
