...
| R² Score | 0.2096 | Poor fit |
| RMSE | 185,612.94 | Root Mean Square Error |
| MAE | 81,135.77 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 35134.6567 | Positive |
| Number_of_Rooms | 27624.7176 | Positive |
| Building_Type | 20761.0644 | Positive |
| Number_of_Bedrooms | 16737.3571 | Positive |
| Housing_Unit_Weight | 12997.6308 | Positive |
| Number_of_Persons | 8757.3187 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3125 | Weak fit |
| RMSE | 311.94 | Root Mean Square Error |
| MAE | 206.47 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 78.5342 | Positive |
| Number_of_Bedrooms | 65.5676 | Positive |
| Building_Type | 54.1531 | Positive |
| Housing_Unit_Weight | 45.8124 | Positive |
| Number_of_Persons | 33.7320 | Positive |
| Number_of_Rooms | 29.0752 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.4890 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 11,651 | 77.7% | Dominant cluster |
| Cluster 1 | 777 | 5.2% | Minor cluster |
| Cluster 2 | 1,686 | 11.2% | Moderate cluster |
| Cluster 3 | 406 | 2.7% | Minor cluster |
| Cluster 4 | 480 | 3.2% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 145.0%).*
...
| polynomial_degree_2 | 0.9247 | — | — | — | 2 |
| polynomial_degree_1 | 0.8825 | — | — | — | 3 |
| holt_winters | 0.7279 | — | — | — | 4 |
| sma | 0.6359 | — | — | — | 5 |
| wma | 0.6182 | — | — | — | 6 |
| arima | 0.4716 | — | — | — | 7 |
| ewma | 0.3610 | — | — | — | 8 |
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9875 | — | — | — | 1 |
| polynomial_degree_2 | 0.9642 | — | — | — | 2 |
| wma | 0.9520 | — | — | — | 3 |
| holt_winters | 0.9460 | — | — | — | 4 |
| sma | 0.9015 | — | — | — | 5 |
| polynomial_degree_1 | 0.8608 | — | — | — | 6 |
| ewma | 0.7626 | — | — | — | 7 |
| arima | -1.4624 | — | — | — | 8 |



> *The polynomial_degree_3 model achieved the best fit with R² = 0.9875. Models are ranked by R² score.*
