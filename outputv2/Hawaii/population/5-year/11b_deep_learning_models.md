...
| Average Validation Loss | 472425476.1047 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1399729408.0000 | Final epoch |
| Validation Loss | 1417275776.0000 | Final epoch |
| Loss Gap | 17546368.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 18044.2930 | Mean Absolute Error (lower is better) |
| MSE | 1359124992.0000 | Mean Squared Error (lower is better) |
| RMSE | 36866.3124 | Root Mean Squared Error (lower is better) |
| R2 | 0.2610 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1807336448.0000 |
| Final Training Loss | 1399729408.0000 |
| Loss Improvement | 22.6% |
| Initial Validation Loss | 1654506880.0000 |
| Final Validation Loss | 1417275776.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 28.8876 | Final epoch |
| Validation Loss | 29.1237 | Final epoch |
| Loss Gap | 0.2360 | MODERATE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 2.0176 | Mean Absolute Error (lower is better) |
| MSE | 28.7251 | Mean Squared Error (lower is better) |
| RMSE | 5.3596 | Root Mean Squared Error (lower is better) |
| R2 | 0.3392 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 45.9620 |
| Final Training Loss | 28.8876 |
| Loss Improvement | 37.1% |
| Initial Validation Loss | 30.8783 |
| Final Validation Loss | 29.1237 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 622.9012 | Final epoch |
| Validation Loss | 623.1905 | Final epoch |
| Loss Gap | 0.2892 | MODERATE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 15.0076 | Mean Absolute Error (lower is better) |
| MSE | 622.1860 | Mean Squared Error (lower is better) |
| RMSE | 24.9437 | Root Mean Squared Error (lower is better) |
| R2 | -5.2342 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 622.6099 |
| Final Training Loss | 622.9012 |
| Loss Improvement | -0.0% |
| Initial Validation Loss | 622.7914 |
| Final Validation Loss | 623.1905 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1399729408.0000 | 1417275776.0000 | 17546368.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 28.8876 | 29.1237 | 0.2360 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 622.9012 | 623.1905 | 0.2892 |
