...
| Average Validation Loss | 488142160.6826 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1481831552.0000 | Final epoch |
| Validation Loss | 1464425856.0000 | Final epoch |
| Loss Gap | -17405696.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 17810.9199 | Mean Absolute Error (lower is better) |
| MSE | 1464607616.0000 | Mean Squared Error (lower is better) |
| RMSE | 38270.1923 | Root Mean Squared Error (lower is better) |
| R2 | 0.2417 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1626482304.0000 |
| Final Training Loss | 1481831552.0000 |
| Loss Improvement | 8.9% |
| Initial Validation Loss | 1516962432.0000 |
| Final Validation Loss | 1464425856.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 24.0812 | Final epoch |
| Validation Loss | 23.9543 | Final epoch |
| Loss Gap | -0.1269 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 1.8039 | Mean Absolute Error (lower is better) |
| MSE | 23.8400 | Mean Squared Error (lower is better) |
| RMSE | 4.8826 | Root Mean Squared Error (lower is better) |
| R2 | 0.3289 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 30.0031 |
| Final Training Loss | 24.0812 |
| Loss Improvement | 19.7% |
| Initial Validation Loss | 24.6299 |
| Final Validation Loss | 23.9543 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 602.5177 | Final epoch |
| Validation Loss | 602.0934 | Final epoch |
| Loss Gap | -0.4243 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 14.6761 | Mean Absolute Error (lower is better) |
| MSE | 601.7496 | Mean Squared Error (lower is better) |
| RMSE | 24.5306 | Root Mean Squared Error (lower is better) |
| R2 | -5.0757 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 601.1317 |
| Final Training Loss | 602.5177 |
| Loss Improvement | -0.2% |
| Initial Validation Loss | 600.6690 |
| Final Validation Loss | 602.0934 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1481831552.0000 | 1464425856.0000 | -17405696.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 24.0812 | 23.9543 | -0.1269 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 602.5177 | 602.0934 | -0.4243 |
