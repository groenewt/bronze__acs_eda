...
| Average Validation Loss | 720548064.7156 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 2248174848.0000 | Final epoch |
| Validation Loss | 2161643520.0000 | Final epoch |
| Loss Gap | -86531328.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 20854.4277 | Mean Absolute Error (lower is better) |
| MSE | 2182441472.0000 | Mean Squared Error (lower is better) |
| RMSE | 46716.6081 | Root Mean Squared Error (lower is better) |
| R2 | 0.2242 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 2559324416.0000 |
| Final Training Loss | 2248174848.0000 |
| Loss Improvement | 12.2% |
| Initial Validation Loss | 2299347200.0000 |
| Final Validation Loss | 2161643520.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 68.9847 | Final epoch |
| Validation Loss | 68.0683 | Final epoch |
| Loss Gap | -0.9164 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.5700 | Mean Absolute Error (lower is better) |
| MSE | 68.7141 | Mean Squared Error (lower is better) |
| RMSE | 8.2894 | Root Mean Squared Error (lower is better) |
| R2 | 0.3223 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 80.9421 |
| Final Training Loss | 68.9847 |
| Loss Improvement | 14.8% |
| Initial Validation Loss | 69.4846 |
| Final Validation Loss | 68.0683 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 605.8609 | Final epoch |
| Validation Loss | 606.0784 | Final epoch |
| Loss Gap | 0.2175 | MODERATE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 14.9617 | Mean Absolute Error (lower is better) |
| MSE | 606.0503 | Mean Squared Error (lower is better) |
| RMSE | 24.6181 | Root Mean Squared Error (lower is better) |
| R2 | -5.4993 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 605.4043 |
| Final Training Loss | 605.8609 |
| Loss Improvement | -0.1% |
| Initial Validation Loss | 605.5162 |
| Final Validation Loss | 606.0784 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 2248174848.0000 | 2161643520.0000 | -86531328.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 68.9847 | 68.0683 | -0.9164 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 605.8609 | 606.0784 | 0.2175 |
