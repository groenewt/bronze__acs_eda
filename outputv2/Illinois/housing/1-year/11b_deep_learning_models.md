...
| Average Validation Loss | 3463738669.0111 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 17407232000.0000 | Final epoch |
| Validation Loss | 17317896192.0000 | Final epoch |
| Loss Gap | -89335808.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 36475.5078 | Mean Absolute Error (lower is better) |
| MSE | 16851932160.0000 | Mean Squared Error (lower is better) |
| RMSE | 129814.9920 | Root Mean Squared Error (lower is better) |
| R2 | -0.0541 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 25008320512.0000 |
| Final Training Loss | 17407232000.0000 |
| Loss Improvement | 30.4% |
| Initial Validation Loss | 18568474624.0000 |
| Final Validation Loss | 17317896192.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 218.7021 | Final epoch |
| Validation Loss | 218.0206 | Final epoch |
| Loss Gap | -0.6815 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 7.3896 | Mean Absolute Error (lower is better) |
| MSE | 219.8804 | Mean Squared Error (lower is better) |
| RMSE | 14.8284 | Root Mean Squared Error (lower is better) |
| R2 | 0.0514 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 248.0775 |
| Final Training Loss | 218.7021 |
| Loss Improvement | 11.8% |
| Initial Validation Loss | 221.1935 |
| Final Validation Loss | 218.0206 |
| Validation Improvement | 1.4% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 90.8313 | Final epoch |
| Validation Loss | 30.3002 | Final epoch |
| Loss Gap | -60.5310 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 1.6942 | Mean Absolute Error (lower is better) |
| MSE | 29.6024 | Mean Squared Error (lower is better) |
| RMSE | 5.4408 | Root Mean Squared Error (lower is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 4607.5674 |
| Final Training Loss | 90.8313 |
| Loss Improvement | 98.0% |
| Initial Validation Loss | 153.2233 |
| Final Validation Loss | 30.3002 |
| Validation Improvement | 80.2% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 778932.0625 | Final epoch |
| Validation Loss | 796904.3750 | Final epoch |
| Loss Gap | 17972.3125 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 252.1703 | Mean Absolute Error (lower is better) |
| MSE | 763304.6875 | Mean Squared Error (lower is better) |
| RMSE | 873.6731 | Root Mean Squared Error (lower is better) |
| R2 | 0.3235 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 987885.9375 |
| Final Training Loss | 778932.0625 |
| Loss Improvement | 21.2% |
| Initial Validation Loss | 880084.7500 |
| Final Validation Loss | 796904.3750 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.3649 | Final epoch |
| Validation Loss | 0.3594 | Final epoch |
| Loss Gap | -0.0055 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3143 | Mean Absolute Error (lower is better) |
| MSE | 0.3590 | Mean Squared Error (lower is better) |
| RMSE | 0.5992 | Root Mean Squared Error (lower is better) |
| R2 | 0.3940 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.7982 |
| Final Training Loss | 0.3649 |
| Loss Improvement | 54.3% |
| Initial Validation Loss | 0.4460 |
| Final Validation Loss | 0.3594 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 17407232000.0000 | 17317896192.0000 | -89335808.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 218.7021 | 218.0206 | -0.6815 |
| Housing Quality | HousingQualityModel | 10,371 | 90.8313 | 30.3002 | -60.5310 |
| Cost Prediction | HousingDefaultModel | 10,306 | 778932.0625 | 796904.3750 | 17972.3125 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.3649 | 0.3594 | -0.0055 |
