...
| Average Validation Loss | 1627880682.9963 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 8589756928.0000 | Final epoch |
| Validation Loss | 8138994176.0000 | Final epoch |
| Loss Gap | -450762752.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 26691.7070 | Mean Absolute Error (lower is better) |
| MSE | 8948078592.0000 | Mean Squared Error (lower is better) |
| RMSE | 94594.2841 | Root Mean Squared Error (lower is better) |
| R2 | -0.5533 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 18464552960.0000 |
| Final Training Loss | 8589756928.0000 |
| Loss Improvement | 53.5% |
| Initial Validation Loss | 14579643392.0000 |
| Final Validation Loss | 8138994176.0000 |
| Validation Improvement | 44.2% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 166.5355 | Final epoch |
| Validation Loss | 168.2043 | Final epoch |
| Loss Gap | 1.6688 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.0588 | Mean Absolute Error (lower is better) |
| MSE | 169.0833 | Mean Squared Error (lower is better) |
| RMSE | 13.0032 | Root Mean Squared Error (lower is better) |
| R2 | 0.0607 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 228.7082 |
| Final Training Loss | 166.5355 |
| Loss Improvement | 27.2% |
| Initial Validation Loss | 174.2933 |
| Final Validation Loss | 168.2043 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 263.9271 | Final epoch |
| Validation Loss | 11.1701 | Final epoch |
| Loss Gap | -252.7570 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.9880 | Mean Absolute Error (lower is better) |
| MSE | 11.2751 | Mean Squared Error (lower is better) |
| RMSE | 3.3578 | Root Mean Squared Error (lower is better) |
| R2 | 0.7658 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 14817.2959 |
| Final Training Loss | 263.9271 |
| Loss Improvement | 98.2% |
| Initial Validation Loss | 2362.4280 |
| Final Validation Loss | 11.1701 |
| Validation Improvement | 99.5% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 440139.5625 | Final epoch |
| Validation Loss | 409059.2500 | Final epoch |
| Loss Gap | -31080.3125 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 259.1655 | Mean Absolute Error (lower is better) |
| MSE | 432924.4062 | Mean Squared Error (lower is better) |
| RMSE | 657.9699 | Root Mean Squared Error (lower is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 769282.7500 |
| Final Training Loss | 440139.5625 |
| Loss Improvement | 42.8% |
| Initial Validation Loss | 511203.5312 |
| Final Validation Loss | 409059.2500 |
| Validation Improvement | 20.0% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.3564 | Final epoch |
| Validation Loss | 0.3570 | Final epoch |
| Loss Gap | 0.0005 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.2970 | Mean Absolute Error (lower is better) |
| MSE | 0.3595 | Mean Squared Error (lower is better) |
| RMSE | 0.5996 | Root Mean Squared Error (lower is better) |
| R2 | 0.3860 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1.7272 |
| Final Training Loss | 0.3564 |
| Loss Improvement | 79.4% |
| Initial Validation Loss | 0.5214 |
| Final Validation Loss | 0.3570 |
| Validation Improvement | 31.5% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 8589756928.0000 | 8138994176.0000 | -450762752.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 166.5355 | 168.2043 | 1.6688 |
| Housing Quality | HousingQualityModel | 10,371 | 263.9271 | 11.1701 | -252.7570 |
| Cost Prediction | HousingDefaultModel | 10,306 | 440139.5625 | 409059.2500 | -31080.3125 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.3564 | 0.3570 | 0.0005 |
