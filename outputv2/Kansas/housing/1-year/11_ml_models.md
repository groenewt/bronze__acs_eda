...
| R² Score | 0.2202 | Poor fit |
| RMSE | 178,201.83 | Root Mean Square Error |
| MAE | 83,331.95 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 39234.9525 | Positive |
| Number_of_Rooms | 24794.8369 | Positive |
| Number_of_Bedrooms | 24442.4878 | Positive |
| Housing_Unit_Weight | 19425.2179 | Positive |
| Building_Type | 8062.7338 | Positive |
| Number_of_Persons | 7279.6096 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3058 | Weak fit |
| RMSE | 383.29 | Root Mean Square Error |
| MAE | 247.84 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 111.9792 | Positive |
| Number_of_Bedrooms | 80.9686 | Positive |
| Housing_Unit_Weight | 58.8192 | Positive |
| Number_of_Persons | 49.6157 | Positive |
| Building_Type | 36.8589 | Positive |
| Number_of_Rooms | 26.7401 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5712 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 12,139 | 80.9% | Dominant cluster |
| Cluster 1 | 556 | 3.7% | Minor cluster |
| Cluster 2 | 824 | 5.5% | Minor cluster |
| Cluster 3 | 1,175 | 7.8% | Minor cluster |
| Cluster 4 | 306 | 2.0% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 152.6%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9936 | — | — | — | 1 |
| polynomial_degree_2 | 0.9348 | — | — | — | 2 |
| polynomial_degree_1 | 0.8916 | — | — | — | 3 |
| holt_winters | 0.7388 | — | — | — | 4 |
| sma | 0.6393 | — | — | — | 5 |
| wma | 0.6203 | — | — | — | 6 |
| arima | 0.4921 | — | — | — | 7 |
| ewma | 0.3669 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9936. Models are ranked by R² score.*
...
| polynomial_degree_2 | 0.9635 | — | — | — | 2 |
| wma | 0.9555 | — | — | — | 3 |
| holt_winters | 0.9411 | — | — | — | 4 |
| polynomial_degree_1 | 0.9217 | — | — | — | 5 |
| sma | 0.9125 | — | — | — | 6 |
| ewma | 0.7768 | — | — | — | 7 |
| arima | -0.8771 | — | — | — | 8 |
