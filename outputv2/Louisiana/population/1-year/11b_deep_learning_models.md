...
| Average Validation Loss | 465336333.1680 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1368400128.0000 | Final epoch |
| Validation Loss | 1396008320.0000 | Final epoch |
| Loss Gap | 27608192.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 17181.6855 | Mean Absolute Error (lower is better) |
| MSE | 1336919168.0000 | Mean Squared Error (lower is better) |
| RMSE | 36563.9053 | Root Mean Squared Error (lower is better) |
| R2 | 0.2452 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1715101056.0000 |
| Final Training Loss | 1368400128.0000 |
| Loss Improvement | 20.2% |
| Initial Validation Loss | 1535751936.0000 |
| Final Validation Loss | 1396008320.0000 |
| Validation Improvement | 9.1% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 65.7412 | Final epoch |
| Validation Loss | 65.8816 | Final epoch |
| Loss Gap | 0.1404 | LOW overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.3417 | Mean Absolute Error (lower is better) |
| MSE | 65.4129 | Mean Squared Error (lower is better) |
| RMSE | 8.0878 | Root Mean Squared Error (lower is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 92.8721 |
| Final Training Loss | 65.7412 |
| Loss Improvement | 29.2% |
| Initial Validation Loss | 68.5897 |
| Final Validation Loss | 65.8816 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 613.6763 | Final epoch |
| Validation Loss | 613.6224 | Final epoch |
| Loss Gap | -0.0538 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 14.9488 | Mean Absolute Error (lower is better) |
| MSE | 611.7090 | Mean Squared Error (lower is better) |
| RMSE | 24.7328 | Root Mean Squared Error (lower is better) |
| R2 | -5.5256 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 613.5608 |
| Final Training Loss | 613.6763 |
| Loss Improvement | -0.0% |
| Initial Validation Loss | 613.3071 |
| Final Validation Loss | 613.6224 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1368400128.0000 | 1396008320.0000 | 27608192.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 65.7412 | 65.8816 | 0.1404 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 613.6763 | 613.6224 | -0.0538 |
