...
| R² Score | 0.0339 | Poor fit |
| RMSE | 466,903.36 | Root Mean Square Error |
| MAE | 158,596.46 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Building_Type | 40624.7922 | Positive |
| Number_of_Rooms | 38079.0612 | Positive |
| Year_Structure_Built | 33381.0448 | Positive |
| Housing_Unit_Weight | 20559.4780 | Positive |
| Number_of_Persons | 10992.2790 | Positive |
| Number_of_Bedrooms | 10417.7475 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2493 | Poor fit |
| RMSE | 442.03 | Root Mean Square Error |
| MAE | 283.15 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 96.5233 | Positive |
| Number_of_Bedrooms | 70.3640 | Positive |
| Building_Type | 68.4361 | Positive |
| Number_of_Rooms | 57.4966 | Positive |
| Housing_Unit_Weight | 52.0055 | Positive |
| Number_of_Persons | 23.3622 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5145 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 11,926 | 79.5% | Dominant cluster |
| Cluster 1 | 867 | 5.8% | Minor cluster |
| Cluster 2 | 1,354 | 9.0% | Minor cluster |
| Cluster 3 | 406 | 2.7% | Minor cluster |
| Cluster 4 | 447 | 3.0% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 149.2%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9592 | — | — | — | 1 |
| polynomial_degree_2 | 0.9541 | — | — | — | 2 |
| polynomial_degree_1 | 0.8527 | — | — | — | 3 |
| holt_winters | 0.7086 | — | — | — | 4 |
| sma | 0.6434 | — | — | — | 5 |
| wma | 0.6225 | — | — | — | 6 |
| arima | 0.4342 | — | — | — | 7 |
| ewma | 0.3667 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9592. Models are ranked by R² score.*
...
| holt_winters | 0.9635 | — | — | — | 2 |
| polynomial_degree_2 | 0.9571 | — | — | — | 3 |
| wma | 0.9515 | — | — | — | 4 |
| sma | 0.9022 | — | — | — | 5 |
| polynomial_degree_1 | 0.8701 | — | — | — | 6 |
| ewma | 0.7632 | — | — | — | 7 |
| arima | -0.8603 | — | — | — | 8 |
