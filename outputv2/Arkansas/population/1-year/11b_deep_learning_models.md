...
| Average Validation Loss | 335598949.6684 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1060588480.0000 | Final epoch |
| Validation Loss | 1006796160.0000 | Final epoch |
| Loss Gap | -53792320.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 14849.3584 | Mean Absolute Error (lower is better) |
| MSE | 1084590976.0000 | Mean Squared Error (lower is better) |
| RMSE | 32933.1289 | Root Mean Squared Error (lower is better) |
| R2 | 0.2301 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1394749824.0000 |
| Final Training Loss | 1060588480.0000 |
| Loss Improvement | 24.0% |
| Initial Validation Loss | 1151321984.0000 |
| Final Validation Loss | 1006796160.0000 |
| Validation Improvement | 12.6% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 61.8862 | Final epoch |
| Validation Loss | 62.1531 | Final epoch |
| Loss Gap | 0.2669 | MODERATE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.2044 | Mean Absolute Error (lower is better) |
| MSE | 61.7821 | Mean Squared Error (lower is better) |
| RMSE | 7.8602 | Root Mean Squared Error (lower is better) |
| R2 | 0.3008 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 97.7817 |
| Final Training Loss | 61.8862 |
| Loss Improvement | 36.7% |
| Initial Validation Loss | 64.7849 |
| Final Validation Loss | 62.1531 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 625.0865 | Final epoch |
| Validation Loss | 626.8520 | Final epoch |
| Loss Gap | 1.7654 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 14.9854 | Mean Absolute Error (lower is better) |
| MSE | 623.3339 | Mean Squared Error (lower is better) |
| RMSE | 24.9667 | Root Mean Squared Error (lower is better) |
| R2 | -5.4602 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 625.2353 |
| Final Training Loss | 625.0865 |
| Loss Improvement | 0.0% |
| Initial Validation Loss | 626.9698 |
| Final Validation Loss | 626.8520 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1060588480.0000 | 1006796160.0000 | -53792320.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 61.8862 | 62.1531 | 0.2669 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 625.0865 | 626.8520 | 1.7654 |
