...
| Average Validation Loss | 7516282429.9864 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 40125034496.0000 | Final epoch |
| Validation Loss | 37581033472.0000 | Final epoch |
| Loss Gap | -2544001024.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 51302.8594 | Mean Absolute Error (lower is better) |
| MSE | 37910560768.0000 | Mean Squared Error (lower is better) |
| RMSE | 194706.3450 | Root Mean Squared Error (lower is better) |
| R2 | -0.2136 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 73056092160.0000 |
| Final Training Loss | 40125034496.0000 |
| Loss Improvement | 45.1% |
| Initial Validation Loss | 69846892544.0000 |
| Final Validation Loss | 37581033472.0000 |
| Validation Improvement | 46.2% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 185.2873 | Final epoch |
| Validation Loss | 182.4233 | Final epoch |
| Loss Gap | -2.8640 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.3008 | Mean Absolute Error (lower is better) |
| MSE | 175.5715 | Mean Squared Error (lower is better) |
| RMSE | 13.2503 | Root Mean Squared Error (lower is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 345.0995 |
| Final Training Loss | 185.2873 |
| Loss Improvement | 46.3% |
| Initial Validation Loss | 214.7207 |
| Final Validation Loss | 182.4233 |
| Validation Improvement | 15.0% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 578.5880 | Final epoch |
| Validation Loss | 19.7072 | Final epoch |
| Loss Gap | -558.8808 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 1.2513 | Mean Absolute Error (lower is better) |
| MSE | 20.9459 | Mean Squared Error (lower is better) |
| RMSE | 4.5767 | Root Mean Squared Error (lower is better) |
| R2 | 0.8502 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 44882.1055 |
| Final Training Loss | 578.5880 |
| Loss Improvement | 98.7% |
| Initial Validation Loss | 21944.8730 |
| Final Validation Loss | 19.7072 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 461222.7812 | Final epoch |
| Validation Loss | 378475.4062 | Final epoch |
| Loss Gap | -82747.3750 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 234.4586 | Mean Absolute Error (lower is better) |
| MSE | 361993.3438 | Mean Squared Error (lower is better) |
| RMSE | 601.6588 | Root Mean Squared Error (lower is better) |
| R2 | 0.2726 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 902853.0000 |
| Final Training Loss | 461222.7812 |
| Loss Improvement | 48.9% |
| Initial Validation Loss | 733183.5000 |
| Final Validation Loss | 378475.4062 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.3912 | Final epoch |
| Validation Loss | 0.3954 | Final epoch |
| Loss Gap | 0.0043 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3240 | Mean Absolute Error (lower is better) |
| MSE | 0.4006 | Mean Squared Error (lower is better) |
| RMSE | 0.6330 | Root Mean Squared Error (lower is better) |
| R2 | 0.1367 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 2.3423 |
| Final Training Loss | 0.3912 |
| Loss Improvement | 83.3% |
| Initial Validation Loss | 1.3779 |
| Final Validation Loss | 0.3954 |
| Validation Improvement | 71.3% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 40125034496.0000 | 37581033472.0000 | -2544001024.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 185.2873 | 182.4233 | -2.8640 |
| Housing Quality | HousingQualityModel | 10,371 | 578.5880 | 19.7072 | -558.8808 |
| Cost Prediction | HousingDefaultModel | 10,306 | 461222.7812 | 378475.4062 | -82747.3750 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.3912 | 0.3954 | 0.0043 |
