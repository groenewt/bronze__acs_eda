...
| R² Score | 0.1809 | Poor fit |
| RMSE | 256,538.29 | Root Mean Square Error |
| MAE | 123,129.95 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 56508.4245 | Positive |
| Number_of_Rooms | 47121.8156 | Positive |
| Number_of_Bedrooms | 26467.3238 | Positive |
| Building_Type | 20890.9757 | Positive |
| Number_of_Persons | 14467.8072 | Positive |
| Housing_Unit_Weight | 2716.3833 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2898 | Poor fit |
| RMSE | 461.81 | Root Mean Square Error |
| MAE | 330.65 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Number_of_Bedrooms | 128.7498 | Positive |
| Year_Structure_Built | 115.3439 | Positive |
| Building_Type | 74.5441 | Positive |
| Number_of_Persons | 70.9868 | Positive |
| Number_of_Rooms | 52.9714 | Positive |
| Housing_Unit_Weight | 33.3449 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.2669 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 18,653 | 32.9% | Major cluster |
| Cluster 1 | 4,264 | 7.5% | Minor cluster |
| Cluster 2 | 7,382 | 13.0% | Moderate cluster |
| Cluster 3 | 2,267 | 4.0% | Minor cluster |
| Cluster 4 | 24,133 | 42.6% | Dominant cluster |



> *Cluster distribution is imbalanced (CV: 75.4%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9865 | — | — | — | 1 |
| polynomial_degree_2 | 0.8874 | — | — | — | 2 |
| polynomial_degree_1 | 0.8660 | — | — | — | 3 |
| holt_winters | 0.7090 | — | — | — | 4 |
| sma | 0.6140 | — | — | — | 5 |
| wma | 0.6038 | — | — | — | 6 |
| arima | 0.4414 | — | — | — | 7 |
| ewma | 0.3641 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9865. Models are ranked by R² score.*
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9822 | — | — | — | 1 |
| polynomial_degree_2 | 0.9663 | — | — | — | 2 |
| wma | 0.9537 | — | — | — | 3 |
| holt_winters | 0.9226 | — | — | — | 4 |
| sma | 0.9040 | — | — | — | 5 |
| polynomial_degree_1 | 0.8682 | — | — | — | 6 |
| ewma | 0.7694 | — | — | — | 7 |
| arima | -0.7465 | — | — | — | 8 |



> *The polynomial_degree_3 model achieved the best fit with R² = 0.9822. Models are ranked by R² score.*
