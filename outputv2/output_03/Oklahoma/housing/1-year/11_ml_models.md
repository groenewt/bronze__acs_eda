...
| R² Score | 0.2039 | Poor fit |
| RMSE | 176,046.92 | Root Mean Square Error |
| MAE | 80,728.04 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 34089.1729 | Positive |
| Number_of_Rooms | 28987.0912 | Positive |
| Building_Type | 18248.7768 | Positive |
| Number_of_Bedrooms | 15448.9288 | Positive |
| Housing_Unit_Weight | 10455.9191 | Positive |
| Number_of_Persons | 8804.8260 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3235 | Weak fit |
| RMSE | 328.76 | Root Mean Square Error |
| MAE | 228.66 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 78.9798 | Positive |
| Number_of_Bedrooms | 65.4181 | Positive |
| Housing_Unit_Weight | 62.4407 | Positive |
| Building_Type | 53.7156 | Positive |
| Number_of_Rooms | 41.5274 | Positive |
| Number_of_Persons | 26.6274 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5536 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 13,888 | 9.0% | Minor cluster |
| Cluster 1 | 7,554 | 4.9% | Minor cluster |
| Cluster 2 | 123,300 | 79.5% | Dominant cluster |
| Cluster 3 | 6,318 | 4.1% | Minor cluster |
| Cluster 4 | 4,018 | 2.6% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 149.1%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9818 | — | — | — | 1 |
| polynomial_degree_2 | 0.9300 | — | — | — | 2 |
| polynomial_degree_1 | 0.8928 | — | — | — | 3 |
| holt_winters | 0.7399 | — | — | — | 4 |
| sma | 0.6471 | — | — | — | 5 |
| wma | 0.6331 | — | — | — | 6 |
| arima | 0.4854 | — | — | — | 7 |
| ewma | 0.3781 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9818. Models are ranked by R² score.*
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9861 | — | — | — | 1 |
| polynomial_degree_2 | 0.9633 | — | — | — | 2 |
| holt_winters | 0.9577 | — | — | — | 3 |
| wma | 0.9553 | — | — | — | 4 |
| polynomial_degree_1 | 0.9186 | — | — | — | 5 |
| sma | 0.9107 | — | — | — | 6 |
| ewma | 0.7757 | — | — | — | 7 |
| arima | -1.0673 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9861. Models are ranked by R² score.*
