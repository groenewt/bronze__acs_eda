...
| Average Validation Loss | 1710604831.7418 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 9447724032.0000 | Final epoch |
| Validation Loss | 8552710144.0000 | Final epoch |
| Loss Gap | -895013888.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 23447.8262 | Mean Absolute Error (lower is better) |
| MSE | 10194535424.0000 | Mean Squared Error (lower is better) |
| RMSE | 100967.9921 | Root Mean Squared Error (lower is better) |
| R2 | -0.3851 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 16607913984.0000 |
| Final Training Loss | 9447724032.0000 |
| Loss Improvement | 43.1% |
| Initial Validation Loss | 11396072448.0000 |
| Final Validation Loss | 8552710144.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 169.0558 | Final epoch |
| Validation Loss | 170.4985 | Final epoch |
| Loss Gap | 1.4427 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 5.9580 | Mean Absolute Error (lower is better) |
| MSE | 167.3145 | Mean Squared Error (lower is better) |
| RMSE | 12.9350 | Root Mean Squared Error (lower is better) |
| R2 | 0.0457 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 226.2166 |
| Final Training Loss | 169.0558 |
| Loss Improvement | 25.3% |
| Initial Validation Loss | 176.4368 |
| Final Validation Loss | 170.4985 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 230.0642 | Final epoch |
| Validation Loss | 11.6177 | Final epoch |
| Loss Gap | -218.4465 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.9859 | Mean Absolute Error (lower is better) |
| MSE | 12.0457 | Mean Squared Error (lower is better) |
| RMSE | 3.4707 | Root Mean Squared Error (lower is better) |
| R2 | 0.8072 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 12104.0811 |
| Final Training Loss | 230.0642 |
| Loss Improvement | 98.1% |
| Initial Validation Loss | 266.7661 |
| Final Validation Loss | 11.6177 |
| Validation Improvement | 95.6% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 342213.0625 | Final epoch |
| Validation Loss | 313832.1250 | Final epoch |
| Loss Gap | -28380.9375 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 243.2625 | Mean Absolute Error (lower is better) |
| MSE | 334939.1250 | Mean Squared Error (lower is better) |
| RMSE | 578.7393 | Root Mean Squared Error (lower is better) |
| R2 | 0.2691 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 545133.5000 |
| Final Training Loss | 342213.0625 |
| Loss Improvement | 37.2% |
| Initial Validation Loss | 344601.0625 |
| Final Validation Loss | 313832.1250 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.4815 | Final epoch |
| Validation Loss | 0.4677 | Final epoch |
| Loss Gap | -0.0138 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3446 | Mean Absolute Error (lower is better) |
| MSE | 0.4720 | Mean Squared Error (lower is better) |
| RMSE | 0.6870 | Root Mean Squared Error (lower is better) |
| R2 | 0.3325 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1.4279 |
| Final Training Loss | 0.4815 |
| Loss Improvement | 66.3% |
| Initial Validation Loss | 0.6264 |
| Final Validation Loss | 0.4677 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 9447724032.0000 | 8552710144.0000 | -895013888.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 169.0558 | 170.4985 | 1.4427 |
| Housing Quality | HousingQualityModel | 10,371 | 230.0642 | 11.6177 | -218.4465 |
| Cost Prediction | HousingDefaultModel | 10,306 | 342213.0625 | 313832.1250 | -28380.9375 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.4815 | 0.4677 | -0.0138 |
