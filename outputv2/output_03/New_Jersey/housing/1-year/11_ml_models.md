...
| R² Score | 0.2289 | Poor fit |
| RMSE | 373,292.75 | Root Mean Square Error |
| MAE | 189,632.43 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Bedrooms | 74041.5942 | Positive |
| Number_of_Rooms | 58759.7466 | Positive |
| Year_Structure_Built | 50624.6793 | Positive |
| Housing_Unit_Weight | 14717.0663 | Positive |
| Number_of_Persons | 12132.5922 | Positive |
| Building_Type | 10388.0368 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.3363 | Weak fit |
| RMSE | 577.65 | Root Mean Square Error |
| MAE | 414.06 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 184.9568 | Positive |
| Number_of_Bedrooms | 146.8028 | Positive |
| Number_of_Persons | 100.2739 | Positive |
| Building_Type | 61.9177 | Positive |
| Number_of_Rooms | 48.3572 | Positive |
| Housing_Unit_Weight | 19.8527 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.4035 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 844 | 5.6% | Minor cluster |
| Cluster 1 | 10,879 | 72.5% | Dominant cluster |
| Cluster 2 | 873 | 5.8% | Minor cluster |
| Cluster 3 | 1,821 | 12.1% | Moderate cluster |
| Cluster 4 | 583 | 3.9% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 132.1%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9960 | — | — | — | 1 |
| polynomial_degree_2 | 0.9047 | — | — | — | 2 |
| polynomial_degree_1 | 0.7963 | — | — | — | 3 |
| holt_winters | 0.6114 | — | — | — | 4 |
| sma | 0.5318 | — | — | — | 5 |
| wma | 0.4904 | — | — | — | 6 |
| ewma | 0.2399 | — | — | — | 7 |
| arima | 0.0194 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9960. Models are ranked by R² score.*
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9945 | — | — | — | 1 |
| holt_winters | 0.9904 | — | — | — | 2 |
| polynomial_degree_2 | 0.9885 | — | — | — | 3 |
| wma | 0.9634 | — | — | — | 4 |
| sma | 0.9277 | — | — | — | 5 |
| polynomial_degree_1 | 0.9217 | — | — | — | 6 |
| ewma | 0.7902 | — | — | — | 7 |
| arima | -0.7514 | — | — | — | 8 |



> *The polynomial_degree_3 model achieved the best fit with R² = 0.9945. Models are ranked by R² score.*
