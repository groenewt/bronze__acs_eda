...
| R² Score | 0.2153 | Poor fit |
| RMSE | 169,443.98 | Root Mean Square Error |
| MAE | 89,858.91 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Year_Structure_Built | 42120.2433 | Positive |
| Number_of_Rooms | 19980.7863 | Positive |
| Housing_Unit_Weight | 17693.5274 | Positive |
| Number_of_Bedrooms | 16507.2473 | Positive |
| Building_Type | 14647.9974 | Positive |
| Number_of_Persons | 9550.5520 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2876 | Poor fit |
| RMSE | 378.88 | Root Mean Square Error |
| MAE | 253.39 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 107.6539 | Positive |
| Number_of_Bedrooms | 79.4940 | Positive |
| Housing_Unit_Weight | 55.9931 | Positive |
| Building_Type | 50.4390 | Positive |
| Number_of_Persons | 48.1256 | Positive |
| Number_of_Rooms | 35.0682 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.5689 | Reasonable structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 4,182 | 12.8% | Moderate cluster |
| Cluster 1 | 1,388 | 4.3% | Minor cluster |
| Cluster 2 | 24,654 | 75.5% | Dominant cluster |
| Cluster 3 | 1,182 | 3.6% | Minor cluster |
| Cluster 4 | 1,239 | 3.8% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 139.9%).*
...
| polynomial_degree_2 | 0.9525 | — | — | — | 2 |
| polynomial_degree_1 | 0.8430 | — | — | — | 3 |
| holt_winters | 0.6754 | — | — | — | 4 |
| sma | 0.6124 | — | — | — | 5 |
| wma | 0.5797 | — | — | — | 6 |
| arima | 0.4611 | — | — | — | 7 |
| ewma | 0.3078 | — | — | — | 8 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| wma | 0.9647 | — | — | — | 1 |
| holt_winters | 0.9628 | — | — | — | 2 |
| polynomial_degree_3 | 0.9603 | — | — | — | 3 |
| polynomial_degree_2 | 0.9595 | — | — | — | 4 |
| polynomial_degree_1 | 0.9542 | — | — | — | 5 |
| sma | 0.9318 | — | — | — | 6 |
| ewma | 0.8007 | — | — | — | 7 |
| arima | -0.3159 | — | — | — | 8 |
...
> *The wma model achieved the best fit with R² = 0.9647. Models are ranked by R² score.*
