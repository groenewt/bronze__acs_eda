...
- **('Property_Value', 0.9882737415128726, 'increasing')**: decreasing trend (slope: 0.0000)

- **('Insurance_Cost_Yearly', 0.8047789789538935, 'increasing')**: decreasing trend (slope: 0.0000)

- **('Owner_Costs_Percentage_Income', 0.8044324932651172, 'decreasing')**: decreasing trend (slope: 0.0000)
