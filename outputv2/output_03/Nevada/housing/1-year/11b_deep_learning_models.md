...
| Average Validation Loss | 6136750543.0345 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 27849252864.0000 | Final epoch |
| Validation Loss | 30683453440.0000 | Final epoch |
| Loss Gap | 2834200576.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 45271.2305 | Mean Absolute Error (lower is better) |
| MSE | 27496038400.0000 | Mean Squared Error (lower is better) |
| RMSE | 165819.2944 | Root Mean Squared Error (lower is better) |
| R2 | -0.3169 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 69312987136.0000 |
| Final Training Loss | 27849252864.0000 |
| Loss Improvement | 59.8% |
| Initial Validation Loss | 69739175936.0000 |
| Final Validation Loss | 30683453440.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 247.8883 | Final epoch |
| Validation Loss | 238.2059 | Final epoch |
| Loss Gap | -9.6824 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 8.1393 | Mean Absolute Error (lower is better) |
| MSE | 245.0382 | Mean Squared Error (lower is better) |
| RMSE | 15.6537 | Root Mean Squared Error (lower is better) |
| R2 | 0.0571 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 345.3914 |
| Final Training Loss | 247.8883 |
| Loss Improvement | 28.2% |
| Initial Validation Loss | 250.1264 |
| Final Validation Loss | 238.2059 |
| Validation Improvement | 4.8% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 275.3740 | Final epoch |
| Validation Loss | 12.8985 | Final epoch |
| Loss Gap | -262.4754 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 1.2568 | Mean Absolute Error (lower is better) |
| MSE | 13.0965 | Mean Squared Error (lower is better) |
| RMSE | 3.6189 | Root Mean Squared Error (lower is better) |
| R2 | 0.7808 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 19883.0254 |
| Final Training Loss | 275.3740 |
| Loss Improvement | 98.6% |
| Initial Validation Loss | 4813.4106 |
| Final Validation Loss | 12.8985 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 316989.5312 | Final epoch |
| Validation Loss | 299023.6250 | Final epoch |
| Loss Gap | -17965.9062 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 179.7458 | Mean Absolute Error (lower is better) |
| MSE | 290099.6875 | Mean Squared Error (lower is better) |
| RMSE | 538.6090 | Root Mean Squared Error (lower is better) |
| R2 | 0.2591 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 465883.1250 |
| Final Training Loss | 316989.5312 |
| Loss Improvement | 32.0% |
| Initial Validation Loss | 356754.5000 |
| Final Validation Loss | 299023.6250 |
| Validation Improvement | 16.2% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.4460 | Final epoch |
| Validation Loss | 0.4428 | Final epoch |
| Loss Gap | -0.0032 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3700 | Mean Absolute Error (lower is better) |
| MSE | 0.4521 | Mean Squared Error (lower is better) |
| RMSE | 0.6724 | Root Mean Squared Error (lower is better) |
| R2 | 0.2810 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1.5443 |
| Final Training Loss | 0.4460 |
| Loss Improvement | 71.1% |
| Initial Validation Loss | 0.5826 |
| Final Validation Loss | 0.4428 |
| Validation Improvement | 24.0% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 27849252864.0000 | 30683453440.0000 | 2834200576.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 247.8883 | 238.2059 | -9.6824 |
| Housing Quality | HousingQualityModel | 10,371 | 275.3740 | 12.8985 | -262.4754 |
| Cost Prediction | HousingDefaultModel | 10,306 | 316989.5312 | 299023.6250 | -17965.9062 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.4460 | 0.4428 | -0.0032 |
