...
| Average Validation Loss | 2113494789.0907 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 10535657472.0000 | Final epoch |
| Validation Loss | 10567154688.0000 | Final epoch |
| Loss Gap | 31497216.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 28249.2305 | Mean Absolute Error (lower is better) |
| MSE | 10855516160.0000 | Mean Squared Error (lower is better) |
| RMSE | 104189.8083 | Root Mean Squared Error (lower is better) |
| R2 | -0.0777 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 18369370112.0000 |
| Final Training Loss | 10535657472.0000 |
| Loss Improvement | 42.6% |
| Initial Validation Loss | 11988220928.0000 |
| Final Validation Loss | 10567154688.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 181.5238 | Final epoch |
| Validation Loss | 178.8147 | Final epoch |
| Loss Gap | -2.7090 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.1915 | Mean Absolute Error (lower is better) |
| MSE | 181.8469 | Mean Squared Error (lower is better) |
| RMSE | 13.4851 | Root Mean Squared Error (lower is better) |
| R2 | 0.0493 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 222.2641 |
| Final Training Loss | 181.5238 |
| Loss Improvement | 18.3% |
| Initial Validation Loss | 183.9240 |
| Final Validation Loss | 178.8147 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 192.7694 | Final epoch |
| Validation Loss | 11.6522 | Final epoch |
| Loss Gap | -181.1172 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 1.0002 | Mean Absolute Error (lower is better) |
| MSE | 12.4008 | Mean Squared Error (lower is better) |
| RMSE | 3.5215 | Root Mean Squared Error (lower is better) |
| R2 | 0.8538 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 8596.0312 |
| Final Training Loss | 192.7694 |
| Loss Improvement | 97.8% |
| Initial Validation Loss | 10.1667 |
| Final Validation Loss | 11.6522 |
| Validation Improvement | -14.6% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 337398.0938 | Final epoch |
| Validation Loss | 319066.6250 | Final epoch |
| Loss Gap | -18331.4688 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 225.8802 | Mean Absolute Error (lower is better) |
| MSE | 341468.0625 | Mean Squared Error (lower is better) |
| RMSE | 584.3527 | Root Mean Squared Error (lower is better) |
| R2 | 0.2767 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 459654.0000 |
| Final Training Loss | 337398.0938 |
| Loss Improvement | 26.6% |
| Initial Validation Loss | 362751.8125 |
| Final Validation Loss | 319066.6250 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.3645 | Final epoch |
| Validation Loss | 0.3615 | Final epoch |
| Loss Gap | -0.0030 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3079 | Mean Absolute Error (lower is better) |
| MSE | 0.3645 | Mean Squared Error (lower is better) |
| RMSE | 0.6037 | Root Mean Squared Error (lower is better) |
| R2 | 0.2219 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.6864 |
| Final Training Loss | 0.3645 |
| Loss Improvement | 46.9% |
| Initial Validation Loss | 0.4437 |
| Final Validation Loss | 0.3615 |
| Validation Improvement | 18.5% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 10535657472.0000 | 10567154688.0000 | 31497216.0000 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 181.5238 | 178.8147 | -2.7090 |
| Housing Quality | HousingQualityModel | 10,371 | 192.7694 | 11.6522 | -181.1172 |
| Cost Prediction | HousingDefaultModel | 10,306 | 337398.0938 | 319066.6250 | -18331.4688 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.3645 | 0.3615 | -0.0030 |
