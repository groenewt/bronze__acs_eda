...
| Average Validation Loss | 463824229.7561 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1376410496.0000 | Final epoch |
| Validation Loss | 1391472000.0000 | Final epoch |
| Loss Gap | 15061504.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 17141.2266 | Mean Absolute Error (lower is better) |
| MSE | 1357439488.0000 | Mean Squared Error (lower is better) |
| RMSE | 36843.4457 | Root Mean Squared Error (lower is better) |
| R2 | 0.2196 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1694562816.0000 |
| Final Training Loss | 1376410496.0000 |
| Loss Improvement | 18.8% |
| Initial Validation Loss | 1557399808.0000 |
| Final Validation Loss | 1391472000.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 67.0414 | Final epoch |
| Validation Loss | 67.7238 | Final epoch |
| Loss Gap | 0.6824 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.4858 | Mean Absolute Error (lower is better) |
| MSE | 66.7131 | Mean Squared Error (lower is better) |
| RMSE | 8.1678 | Root Mean Squared Error (lower is better) |
| R2 | 0.3194 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 86.6018 |
| Final Training Loss | 67.0414 |
| Loss Improvement | 22.6% |
| Initial Validation Loss | 70.3970 |
| Final Validation Loss | 67.7238 |
| Validation Improvement | 3.8% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 620.3073 | Final epoch |
| Validation Loss | 621.5444 | Final epoch |
| Loss Gap | 1.2371 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 15.0406 | Mean Absolute Error (lower is better) |
| MSE | 620.1742 | Mean Squared Error (lower is better) |
| RMSE | 24.9033 | Root Mean Squared Error (lower is better) |
| R2 | -5.5512 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 620.0931 |
| Final Training Loss | 620.3073 |
| Loss Improvement | -0.0% |
| Initial Validation Loss | 621.1416 |
| Final Validation Loss | 621.5444 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1376410496.0000 | 1391472000.0000 | 15061504.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 67.0414 | 67.7238 | 0.6824 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 620.3073 | 621.5444 | 1.2371 |
