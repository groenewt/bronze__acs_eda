...
| R² Score | 0.2117 | Poor fit |
| RMSE | 250,596.78 | Root Mean Square Error |
| MAE | 121,670.79 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Rooms | 63299.2807 | Positive |
| Year_Structure_Built | 52892.9394 | Positive |
| Number_of_Bedrooms | 30596.4660 | Positive |
| Building_Type | 28287.0009 | Positive |
| Housing_Unit_Weight | 19198.2860 | Positive |
| Number_of_Persons | 16432.3763 | Positive |
...
| R² Score | 0.3651 | Weak fit |
| RMSE | 404.35 | Root Mean Square Error |
| MAE | 270.26 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 128.5235 | Positive |
| Building_Type | 90.9901 | Positive |
| Number_of_Bedrooms | 75.8161 | Positive |
| Number_of_Rooms | 51.6259 | Positive |
| Number_of_Persons | 35.9971 | Positive |
| Housing_Unit_Weight | 23.5995 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.4893 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 314,050 | 76.1% | Dominant cluster |
| Cluster 1 | 21,187 | 5.1% | Minor cluster |
| Cluster 2 | 49,040 | 11.9% | Moderate cluster |
| Cluster 3 | 11,630 | 2.8% | Minor cluster |
| Cluster 4 | 16,976 | 4.1% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 141.0%).*
...
| polynomial_degree_2 | 0.9135 | — | — | — | 2 |
| polynomial_degree_1 | 0.9021 | — | — | — | 3 |
| holt_winters | 0.7608 | — | — | — | 4 |
| sma | 0.6671 | — | — | — | 5 |
| wma | 0.6614 | — | — | — | 6 |
| ewma | 0.4135 | — | — | — | 7 |
| arima | 0.4031 | — | — | — | 8 |
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9929 | — | — | — | 1 |
| holt_winters | 0.9799 | — | — | — | 2 |
| polynomial_degree_2 | 0.9748 | — | — | — | 3 |
| wma | 0.9587 | — | — | — | 4 |
| sma | 0.9131 | — | — | — | 5 |
| polynomial_degree_1 | 0.8878 | — | — | — | 6 |
| ewma | 0.7753 | — | — | — | 7 |
| arima | -0.1420 | — | — | — | 8 |



> *The polynomial_degree_3 model achieved the best fit with R² = 0.9929. Models are ranked by R² score.*
