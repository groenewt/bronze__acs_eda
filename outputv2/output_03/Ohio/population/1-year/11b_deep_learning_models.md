...
| Average Validation Loss | 462091707.9166 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1435019264.0000 | Final epoch |
| Validation Loss | 1386274432.0000 | Final epoch |
| Loss Gap | -48744832.0000 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 17513.6953 | Mean Absolute Error (lower is better) |
| MSE | 1417622528.0000 | Mean Squared Error (lower is better) |
| RMSE | 37651.3284 | Root Mean Squared Error (lower is better) |
| R2 | 0.2368 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 1716471936.0000 |
| Final Training Loss | 1435019264.0000 |
| Loss Improvement | 16.4% |
| Initial Validation Loss | 1535038336.0000 |
| Final Validation Loss | 1386274432.0000 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 67.9281 | Final epoch |
| Validation Loss | 67.2788 | Final epoch |
| Loss Gap | -0.6493 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.5280 | Mean Absolute Error (lower is better) |
| MSE | 67.1741 | Mean Squared Error (lower is better) |
| RMSE | 8.1960 | Root Mean Squared Error (lower is better) |
| R2 | 0.3208 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 80.6378 |
| Final Training Loss | 67.9281 |
| Loss Improvement | 15.8% |
| Initial Validation Loss | 68.7401 |
| Final Validation Loss | 67.2788 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 623.6803 | Final epoch |
| Validation Loss | 624.4711 | Final epoch |
| Loss Gap | 0.7908 | HIGH overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 15.1131 | Mean Absolute Error (lower is better) |
| MSE | 623.6481 | Mean Squared Error (lower is better) |
| RMSE | 24.9729 | Root Mean Squared Error (lower is better) |
| R2 | -5.6188 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 623.1893 |
| Final Training Loss | 623.6803 |
| Loss Improvement | -0.1% |
| Initial Validation Loss | 623.8731 |
| Final Validation Loss | 624.4711 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1435019264.0000 | 1386274432.0000 | -48744832.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 67.9281 | 67.2788 | -0.6493 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 623.6803 | 624.4711 | 0.7908 |
