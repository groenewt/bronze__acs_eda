...
| R² Score | 0.1845 | Poor fit |
| RMSE | 309,779.73 | Root Mean Square Error |
| MAE | 132,367.12 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Rooms | 45294.3893 | Positive |
| Year_Structure_Built | 45195.1259 | Positive |
| Number_of_Bedrooms | 38477.4847 | Positive |
| Building_Type | 35502.2981 | Positive |
| Number_of_Persons | 19575.2952 | Positive |
| Housing_Unit_Weight | 13529.1210 | Positive |
...
| :--- | :--- | :--- |
| Best Model | gradient_boosting | — |
| R² Score | 0.2722 | Poor fit |
| RMSE | 447.83 | Root Mean Square Error |
| MAE | 286.40 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Year_Structure_Built | 119.2599 | Positive |
| Building_Type | 82.6582 | Positive |
| Number_of_Bedrooms | 80.6485 | Positive |
| Number_of_Rooms | 45.1538 | Positive |
| Number_of_Persons | 33.3960 | Positive |
| Housing_Unit_Weight | 11.3594 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Adjustment_Factor | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.4983 | Weak structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 155,264 | 76.1% | Dominant cluster |
| Cluster 1 | 10,476 | 5.1% | Minor cluster |
| Cluster 2 | 23,780 | 11.7% | Moderate cluster |
| Cluster 3 | 5,808 | 2.8% | Minor cluster |
| Cluster 4 | 8,620 | 4.2% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 141.1%).*
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9969 | — | — | — | 1 |
| polynomial_degree_2 | 0.9307 | — | — | — | 2 |
| polynomial_degree_1 | 0.9179 | — | — | — | 3 |
| holt_winters | 0.7844 | — | — | — | 4 |
| sma | 0.6851 | — | — | — | 5 |
| wma | 0.6794 | — | — | — | 6 |
| arima | 0.5805 | — | — | — | 7 |
| ewma | 0.4279 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9969. Models are ranked by R² score.*
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9862 | — | — | — | 1 |
| polynomial_degree_2 | 0.9675 | — | — | — | 2 |
| holt_winters | 0.9639 | — | — | — | 3 |
| wma | 0.9551 | — | — | — | 4 |
| sma | 0.9103 | — | — | — | 5 |
| polynomial_degree_1 | 0.9065 | — | — | — | 6 |
| ewma | 0.7767 | — | — | — | 7 |
| arima | -0.2521 | — | — | — | 8 |



> *The polynomial_degree_3 model achieved the best fit with R² = 0.9862. Models are ranked by R² score.*
