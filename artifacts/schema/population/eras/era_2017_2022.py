...
class Population1Year_2017_2022(PopulationSurvey):
    """
    Population survey schema for 2017-2022 era.

    Key characteristics:
    - Has: DIVISION, REGION (geography)
    - Military: consolidated codes MLPCD, MLPFG, MLPHI, MLPJK
    - NO SSPA
    ...
    def _pop_demo_mapping(self) -> Dict[str, str]:
        """Demographics with consolidated military codes"""
        base = {
            'AGEP': 'Age',
        ...
        # 2017+ format: consolidated military service period codes
        base.update({
    ...
    def _pop_work_income_mapping(self) -> Dict[str, str]:
        """Work and income - NO SSPA in 2017+"""
        return {
    ...
    def _pop_disability_mapping(self) -> Dict[str, str]:
        """Disability columns - available in 2017-2022"""
        return {
    ...
    def _pop_health_insurance_mapping(self) -> Dict[str, str]:
        """Health insurance columns - available in 2017-2022"""
        return {
    ...
    def _pop_education_field_mapping(self) -> Dict[str, str]:
        """Education field columns - available in 2017-2022"""
        return {
    ...
    def _pop_geography_mapping(self) -> Dict[str, str]:
        """Geography columns - available in 2017+"""
        return {
