...
class Population1Year(PopulationSurvey):
    ...
    def _pop_race_additional_mapping(self) -> Dict[str, str]:
        ...
        race.update({'SFN': 'Subfamily_Number', 'SFR': 'Subfamily_Relationship', 'VPS': 'Veteran_Period_Of_Service',
                     ...
                     # Raw industry/occupation codes (generic)
                     'INDP': 'Industry_Code', 'OCCP': 'Occupation_Code'})
        return race

    def _pop_education_field_mapping(self) -> Dict[str, str]:
        """Map raw education field column names to standardized names"""
        return {
    ...
    def _pop_disability_mapping(self) -> Dict[str, str]:
        """Map raw disability column names to standardized names"""
        return {
    ...
    def _pop_health_insurance_mapping(self) -> Dict[str, str]:
        """Map raw health insurance column names to standardized names"""
        return {
