...
| R² Score | 0.4587 | Weak fit |
| RMSE | 3.41 | Root Mean Square Error |
| MAE | 2.40 | Mean Absolute Error |
...
| :--- | :--- | :--- |
| Number_of_Rooms | 1.3113 | Positive |
| Building_Type | 0.8229 | Positive |
| Housing_Unit_Weight | 0.6867 | Positive |
| Year_Structure_Built | 0.4139 | Positive |
| Number_of_Persons | 0.3038 | Positive |
| Number_of_Bedrooms | 0.2100 | Positive |
| Housing_Adjustment_Factor | 0.1486 | Positive |
...
| R² Score | 0.4692 | Weak fit |
| RMSE | 328.01 | Root Mean Square Error |
| MAE | 240.46 | Mean Absolute Error |
| Sample Weights | Applied | ACS weights used |
...
| Feature | SHAP Value | Impact |
| :--- | :--- | :--- |
| Number_of_Bedrooms | 104.1268 | Positive |
| Number_of_Rooms | 101.8171 | Positive |
| Housing_Unit_Weight | 80.8543 | Positive |
| Building_Type | 54.1979 | Positive |
| Number_of_Persons | 49.2019 | Positive |
| Year_Structure_Built | 34.2154 | Positive |
| Housing_Adjustment_Factor | 31.0177 | Positive |
| Census_Division | 0.0000 | Negative |
| Census_Region | 0.0000 | Negative |
| Housing_Unit_Type | 0.0000 | Negative |
...
| Silhouette Score | 0.2170 | No substantial structure |
...
| :--- | :--- | :--- | :--- |
| Cluster 0 | 6,472 | 15.0% | Moderate cluster |
| Cluster 1 | 16,376 | 38.1% | Major cluster |
| Cluster 2 | 6,152 | 14.3% | Moderate cluster |
| Cluster 3 | 11,105 | 25.8% | Major cluster |
| Cluster 4 | 2,913 | 6.8% | Minor cluster |



> *Cluster distribution is imbalanced (CV: 54.4%).*
...
| polynomial_degree_1 | 0.8808 | — | — | — | 3 |
| holt_winters | 0.8808 | — | — | — | 4 |
| sma | 0.0000 | — | — | — | 5 |
| ewma | -0.0697 | — | — | — | 6 |
| wma | -0.1468 | — | — | — | 7 |
| arima | -4830.0027 | — | — | — | 8 |
...
| Model | R² | MAE | RMSE | MAPE | Rank |
| :--- | :--- | :--- | :--- | :--- | :--- |
| polynomial_degree_3 | 0.9919 | — | — | — | 1 |
| polynomial_degree_2 | 0.9919 | — | — | — | 2 |
| holt_winters | 0.9916 | — | — | — | 3 |
| polynomial_degree_1 | 0.9700 | — | — | — | 4 |
| wma | 0.9644 | — | — | — | 5 |
| sma | 0.9406 | — | — | — | 6 |
| ewma | 0.7794 | — | — | — | 7 |
| arima | -5.2998 | — | — | — | 8 |
...
> *The polynomial_degree_3 model achieved the best fit with R² = 0.9919. Models are ranked by R² score.*
