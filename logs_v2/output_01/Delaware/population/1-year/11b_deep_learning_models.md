...
| Average Validation Loss | 643281311.0640 |
| Number of Tasks | 3 |
...
| :--- | :--- | :--- |
| Training Loss | 1926784896.0000 | Final epoch |
| Validation Loss | 1929843200.0000 | Final epoch |
| Loss Gap | 3058304.0000 | HIGH overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 21463.8594 | Mean Absolute Error (lower is better) |
| MSE | 1826663552.0000 | Mean Squared Error (lower is better) |
| RMSE | 42739.4847 | Root Mean Squared Error (lower is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 3263188992.0000 |
| Final Training Loss | 1926784896.0000 |
| Loss Improvement | 41.0% |
| Initial Validation Loss | 3073885184.0000 |
| Final Validation Loss | 1929843200.0000 |
| Validation Improvement | 37.2% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 67.2336 | Final epoch |
| Validation Loss | 66.3936 | Final epoch |
| Loss Gap | -0.8400 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 3.6935 | Mean Absolute Error (lower is better) |
| MSE | 68.5695 | Mean Squared Error (lower is better) |
| RMSE | 8.2807 | Root Mean Squared Error (lower is better) |
| R2 | 0.3019 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 155.2125 |
| Final Training Loss | 67.2336 |
| Loss Improvement | 56.7% |
| Initial Validation Loss | 75.0292 |
| Final Validation Loss | 66.3936 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 667.4030 | Final epoch |
| Validation Loss | 666.7983 | Final epoch |
| Loss Gap | -0.6047 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 15.7111 | Mean Absolute Error (lower is better) |
| MSE | 669.4880 | Mean Squared Error (lower is better) |
| RMSE | 25.8745 | Root Mean Squared Error (lower is better) |
| R2 | -5.7470 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 668.0185 |
| Final Training Loss | 667.4030 |
| Loss Improvement | 0.1% |
| Initial Validation Loss | 667.0049 |
| Final Validation Loss | 666.7983 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Income Prediction | PopulationIncomeModel | 37,123 | 1926784896.0000 | 1929843200.0000 | 3058304.0000 |
| Employment Analysis | PopulationEmploymentModel | 10,371 | 67.2336 | 66.3936 | -0.8400 |
| Demographic Profile | PopulationDemographicModel | 10,436 | 667.4030 | 666.7983 | -0.6047 |
