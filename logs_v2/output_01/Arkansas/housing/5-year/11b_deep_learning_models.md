...
| Average Validation Loss | 30198.7370 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 11437.3379 | Final epoch |
| Validation Loss | 11411.4336 | Final epoch |
| Loss Gap | -25.9043 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 27.9685 | Mean Absolute Error (lower is better) |
| MSE | 11392.9229 | Mean Squared Error (lower is better) |
| RMSE | 106.7376 | Root Mean Squared Error (lower is better) |
| R2 | 0.0659 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 22998.2656 |
| Final Training Loss | 11437.3379 |
| Loss Improvement | 50.3% |
| Initial Validation Loss | 12121.4385 |
| Final Validation Loss | 11411.4336 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 172.6307 | Final epoch |
| Validation Loss | 172.3746 | Final epoch |
| Loss Gap | -0.2561 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 6.0892 | Mean Absolute Error (lower is better) |
| MSE | 173.8152 | Mean Squared Error (lower is better) |
| RMSE | 13.1839 | Root Mean Squared Error (lower is better) |
| R2 | 0.0494 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 196.2471 |
| Final Training Loss | 172.6307 |
| Loss Improvement | 12.0% |
| Initial Validation Loss | 174.5881 |
| Final Validation Loss | 172.3746 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.0063 | Final epoch |
| Validation Loss | 0.0294 | Final epoch |
| Loss Gap | 0.0231 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.0457 | Mean Absolute Error (lower is better) |
| MSE | 0.0290 | Mean Squared Error (lower is better) |
| RMSE | 0.1704 | Root Mean Squared Error (lower is better) |
| R2 | 0.9878 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.3640 |
| Final Training Loss | 0.0063 |
| Loss Improvement | 98.3% |
| Initial Validation Loss | 0.0462 |
| Final Validation Loss | 0.0294 |
| Validation Improvement | 36.3% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 141361.7500 | Final epoch |
| Validation Loss | 139409.4375 | Final epoch |
| Loss Gap | -1952.3125 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 157.5430 | Mean Absolute Error (lower is better) |
| MSE | 143173.2812 | Mean Squared Error (lower is better) |
| RMSE | 378.3825 | Root Mean Squared Error (lower is better) |
| R2 | 0.1389 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 174116.2812 |
| Final Training Loss | 141361.7500 |
| Loss Improvement | 18.8% |
| Initial Validation Loss | 143014.2812 |
| Final Validation Loss | 139409.4375 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.4176 | Final epoch |
| Validation Loss | 0.4101 | Final epoch |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3171 | Mean Absolute Error (lower is better) |
| MSE | 0.4164 | Mean Squared Error (lower is better) |
| RMSE | 0.6453 | Root Mean Squared Error (lower is better) |
| R2 | 0.2042 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.6660 |
| Final Training Loss | 0.4176 |
| Loss Improvement | 37.3% |
| Initial Validation Loss | 0.4325 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 11437.3379 | 11411.4336 | -25.9043 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 172.6307 | 172.3746 | -0.2561 |
| Housing Quality | HousingQualityModel | 10,371 | 0.0063 | 0.0294 | 0.0231 |
| Cost Prediction | HousingDefaultModel | 10,306 | 141361.7500 | 139409.4375 | -1952.3125 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.4176 | 0.4101 | -0.0075 |
