...
- **('Property_Value', 0.9727772675820765, 'increasing')**: decreasing trend (slope: 0.0000)

- **('Gross_Rent', 0.9211807463913297, 'increasing')**: decreasing trend (slope: 0.0000)

- **('Rent_Amount_Monthly', 0.9097718540151349, 'increasing')**: decreasing trend (slope: 0.0000)

- **('Mobile_Home_Costs_Monthly', 0.8615070912301781, 'increasing')**: decreasing trend (slope: 0.0000)

- **('Household_Income', 0.8572721000328196, 'increasing')**: decreasing trend (slope: 0.0000)

- **('Owner_Costs_Percentage_Income', 0.8539500479857689, 'decreasing')**: decreasing trend (slope: 0.0000)

- **('Family_Income', 0.8427483085620961, 'increasing')**: decreasing trend (slope: 0.0000)

- **('Income_to_FPL_Ratio', 0.8395938466422194, 'increasing')**: decreasing trend (slope: 0.0000)

- **('Insurance_Cost_Yearly', 0.826934649738251, 'increasing')**: decreasing trend (slope: 0.0000)

- **('Electricity_Cost_Monthly', 0.7805243397946294, 'increasing')**: decreasing trend (slope: 0.0000)

- **('Fuel_Cost_Monthly', 0.7023936769521022, 'increasing')**: decreasing trend (slope: 0.0000)
