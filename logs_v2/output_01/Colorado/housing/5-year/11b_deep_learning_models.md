...
| Average Validation Loss | 63504.3612 |
| Number of Tasks | 5 |
...
| :--- | :--- | :--- |
| Training Loss | 41926.9023 | Final epoch |
| Validation Loss | 39332.4102 | Final epoch |
| Loss Gap | -2594.4922 | NONE overfitting risk |
...
| :--- | :--- | :--- |
| MAE | 61.6283 | Mean Absolute Error (lower is better) |
| MSE | 41115.9023 | Mean Squared Error (lower is better) |
| RMSE | 202.7706 | Root Mean Squared Error (lower is better) |
| R2 | 0.0821 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 63391.4102 |
| Final Training Loss | 41926.9023 |
| Loss Improvement | 33.9% |
| Initial Validation Loss | 41042.2461 |
| Final Validation Loss | 39332.4102 |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 212.4193 | Final epoch |
| Validation Loss | 211.4440 | Final epoch |
| Loss Gap | -0.9752 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 7.1673 | Mean Absolute Error (lower is better) |
| MSE | 211.9911 | Mean Squared Error (lower is better) |
| RMSE | 14.5599 | Root Mean Squared Error (lower is better) |
| R2 | 0.0539 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 231.0507 |
| Final Training Loss | 212.4193 |
| Loss Improvement | 8.1% |
| Initial Validation Loss | 213.4664 |
| Final Validation Loss | 211.4440 |
| Validation Improvement | 0.9% |
...
| Validation Loss | 0.0558 | Final epoch |
| Loss Gap | 0.0481 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.0866 | Mean Absolute Error (lower is better) |
| MSE | 0.0553 | Mean Squared Error (lower is better) |
| RMSE | 0.2353 | Root Mean Squared Error (lower is better) |
| R2 | 0.9865 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.3409 |
| Final Training Loss | 0.0077 |
| Loss Improvement | 97.7% |
| Initial Validation Loss | 0.0904 |
| Final Validation Loss | 0.0558 |
| Validation Improvement | 38.3% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 279472.8750 | Final epoch |
| Validation Loss | 277977.5625 | Final epoch |
| Loss Gap | -1495.3125 | NONE overfitting risk |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 210.7905 | Mean Absolute Error (lower is better) |
| MSE | 277655.0000 | Mean Squared Error (lower is better) |
| RMSE | 526.9298 | Root Mean Squared Error (lower is better) |
| R2 | 0.1306 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 326176.6875 |
| Final Training Loss | 279472.8750 |
| Loss Improvement | 14.3% |
| Initial Validation Loss | 287252.8438 |
| Final Validation Loss | 277977.5625 |
| Validation Improvement | 3.2% |
...
| Metric | Value | Assessment |
| :--- | :--- | :--- |
| Training Loss | 0.3356 | Final epoch |
| Validation Loss | 0.3337 | Final epoch |
...
| Metric | Value | Description |
| :--- | :--- | :--- |
| MAE | 0.3001 | Mean Absolute Error (lower is better) |
| MSE | 0.3328 | Mean Squared Error (lower is better) |
| RMSE | 0.5769 | Root Mean Squared Error (lower is better) |
| R2 | 0.2817 | R-squared (higher is better) |
...
| :--- | :--- |
| Epochs Trained | 75 |
| Initial Training Loss | 0.4979 |
| Final Training Loss | 0.3356 |
| Loss Improvement | 32.6% |
| Initial Validation Loss | 0.3547 |
| Final Validation Loss | 0.3337 |
| Validation Improvement | 5.9% |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Property Valuation | HousingValuationModel | 36,994 | 41926.9023 | 39332.4102 | -2594.4922 |
| Affordability Analysis | HousingAffordabilityModel | 10,306 | 212.4193 | 211.4440 | -0.9752 |
| Housing Quality | HousingQualityModel | 10,371 | 0.0077 | 0.0558 | 0.0481 |
| Cost Prediction | HousingDefaultModel | 10,306 | 279472.8750 | 277977.5625 | -1495.3125 |
| Occupancy Prediction | HousingDefaultModel | 10,306 | 0.3356 | 0.3337 | -0.0019 |
